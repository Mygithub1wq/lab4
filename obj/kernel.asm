...
c010005d:	e8 bc b1 00 00       	call   c010b21e <memset>
...
c010009f:	e8 70 a3 00 00       	call   c010a414 <proc_init>
...
c01000b8:	e8 16 a5 00 00       	call   c010a5d3 <cpu_idle>
...
c01011af:	e8 6a a0 00 00       	call   c010b21e <memset>
...
c0101246:	e8 cc 9b 00 00       	call   c010ae17 <rand>
...
c01012cc:	e8 4d 9f 00 00       	call   c010b21e <memset>
    for (i = 0; i < total; i ++) {
...
c01017d8:	e8 82 91 00 00       	call   c010a95f <vprintfmt>
    return cnt;
...
c0101a20:	c7 45 f0 4c 06 12 c0 	movl   $0xc012064c,-0x10(%ebp)
    stabstr = __STABSTR_BEGIN__;
c0101a27:	c7 45 ec 4d 06 12 c0 	movl   $0xc012064d,-0x14(%ebp)
    stabstr_end = __STABSTR_END__;
c0101a2e:	c7 45 e8 52 53 12 c0 	movl   $0xc0125352,-0x18(%ebp)
...
c0101b8d:	e8 00 95 00 00       	call   c010b092 <strfind>
...
c0101d3c:	c7 44 24 04 a7 b3 10 	movl   $0xc010b3a7,0x4(%esp)
c0101d43:	c0 
...
c0101f58:	e8 02 91 00 00       	call   c010b05f <strchr>
...
c0101fc5:	e8 95 90 00 00       	call   c010b05f <strchr>
...
c010202a:	e8 91 8f 00 00       	call   c010afc0 <strcmp>
...
c01026ac:	e8 ac 8b 00 00       	call   c010b25d <memmove>
...
c0106b0b:	e8 0e 47 00 00       	call   c010b21e <memset>
...
c0107824:	e8 c6 36 00 00       	call   c010aeef <strlen>
...
c0109b5f:	e8 38 08 00 00       	call   c010a39c <do_exit>
...
c0109d3b:	e8 de 14 00 00       	call   c010b21e <memset>
        proc->tf = NULL;
...
c0109d79:	e8 a0 14 00 00       	call   c010b21e <memset>
    }
    return proc;
...
c0109da2:	e8 77 14 00 00       	call   c010b21e <memset>
...
c0109dbf:	e8 3c 15 00 00       	call   c010b300 <memcpy>
}
c0109dc4:	c9                   	leave  
c0109dc5:	c3                   	ret    
...
c0109de3:	e8 36 14 00 00       	call   c010b21e <memset>
...
c0109e01:	e8 fa 14 00 00       	call   c010b300 <memcpy>
}
c0109e06:	c9                   	leave  
c0109e07:	c3                   	ret    
...
c0109f63:	e8 86 06 00 00       	call   c010a5ee <switch_to>
        }
        local_intr_restore(intr_flag);
...
c0109fab:	e8 c1 07 00 00       	call   c010a771 <hash32>
...
c010a02c:	e8 40 07 00 00       	call   c010a771 <hash32>
...
c010a097:	e8 82 11 00 00       	call   c010b21e <memset>
    tf.tf_cs = KERNEL_CS;
...
c010a27b:	7e 05                	jle    c010a282 <do_fork+0x1e>
        goto fork_out;
c010a27d:	e9 06 01 00 00       	jmp    c010a388 <do_fork+0x124>
    }
    ret = -E_NO_MEM;
...
c010a295:	75 05                	jne    c010a29c <do_fork+0x38>
        goto fork_out;
c010a297:	e9 ec 00 00 00       	jmp    c010a388 <do_fork+0x124>
    }
...
c010a2b7:	e9 d1 00 00 00       	jmp    c010a38d <do_fork+0x129>
    }
...
c010a2de:	e9 aa 00 00 00       	jmp    c010a38d <do_fork+0x129>
    //根据clone_flag标志复制或共享进程内存管理结构
    if (copy_mm(clone_flags, proc) != 0) {
        goto bad_fork_cleanup_kstack;
    }
...
c010a2f7:	e8 90 fe ff ff       	call   c010a18c <copy_thread>
    //将子进程的PCB添加到hash_list和proc_list两个全局进程链表中
        ...
        proc->pid = get_pid();
c010a2fc:	e8 07 fb ff ff       	call   c0109e08 <get_pid>
c010a301:	8b 55 f0             	mov    -0x10(%ebp),%edx
c010a304:	89 42 04             	mov    %eax,0x4(%edx)
        hash_proc(proc);
c010a307:	8b 45 f0             	mov    -0x10(%ebp),%eax
c010a30a:	89 04 24             	mov    %eax,(%esp)
c010a30d:	e8 7b fc ff ff       	call   c0109f8d <hash_proc>
        list_add(&proc_list, &(proc->list_link));
c010a312:	8b 45 f0             	mov    -0x10(%ebp),%eax
c010a315:	83 c0 58             	add    $0x58,%eax
c010a318:	c7 45 ec 70 e1 12 c0 	movl   $0xc012e170,-0x14(%ebp)
c010a31f:	89 45 e8             	mov    %eax,-0x18(%ebp)
c010a322:	8b 45 ec             	mov    -0x14(%ebp),%eax
c010a325:	89 45 e4             	mov    %eax,-0x1c(%ebp)
c010a328:	8b 45 e8             	mov    -0x18(%ebp),%eax
c010a32b:	89 45 e0             	mov    %eax,-0x20(%ebp)
 * Insert the new element @elm *after* the element @listelm which
 * is already in the list.
 * */
static inline void
list_add_after(list_entry_t *listelm, list_entry_t *elm) {
    __list_add(elm, listelm, listelm->next);
c010a32e:	8b 45 e4             	mov    -0x1c(%ebp),%eax
c010a331:	8b 40 04             	mov    0x4(%eax),%eax
c010a334:	8b 55 e0             	mov    -0x20(%ebp),%edx
c010a337:	89 55 dc             	mov    %edx,-0x24(%ebp)
c010a33a:	8b 55 e4             	mov    -0x1c(%ebp),%edx
c010a33d:	89 55 d8             	mov    %edx,-0x28(%ebp)
c010a340:	89 45 d4             	mov    %eax,-0x2c(%ebp)
 * This is only for internal list manipulation where we know
 * the prev/next entries already!
 * */
static inline void
...
c010a346:	8b 55 dc             	mov    -0x24(%ebp),%edx
c010a349:	89 10                	mov    %edx,(%eax)
c010a34b:	8b 45 d4             	mov    -0x2c(%ebp),%eax
c010a34e:	8b 10                	mov    (%eax),%edx
c010a350:	8b 45 d8             	mov    -0x28(%ebp),%eax
c010a353:	89 50 04             	mov    %edx,0x4(%eax)
    elm->next = next;
c010a356:	8b 45 dc             	mov    -0x24(%ebp),%eax
c010a359:	8b 55 d4             	mov    -0x2c(%ebp),%edx
c010a35c:	89 50 04             	mov    %edx,0x4(%eax)
    elm->prev = prev;
c010a35f:	8b 45 dc             	mov    -0x24(%ebp),%eax
c010a362:	8b 55 d8             	mov    -0x28(%ebp),%edx
c010a365:	89 10                	mov    %edx,(%eax)
        nr_process ++;
c010a367:	a1 60 e0 12 c0       	mov    0xc012e060,%eax
c010a36c:	83 c0 01             	add    $0x1,%eax
c010a36f:	a3 60 e0 12 c0       	mov    %eax,0xc012e060
  
    //设置新的子进程可执行
    wakeup_proc(proc);
c010a374:	8b 45 f0             	mov    -0x10(%ebp),%eax
c010a377:	89 04 24             	mov    %eax,(%esp)
c010a37a:	e8 e3 02 00 00       	call   c010a662 <wakeup_proc>
    //返回子进程的pid
    ret = proc->pid;
c010a37f:	8b 45 f0             	mov    -0x10(%ebp),%eax
c010a382:	8b 40 04             	mov    0x4(%eax),%eax
c010a385:	89 45 f4             	mov    %eax,-0xc(%ebp)


fork_out:
    return ret;
c010a388:	8b 45 f4             	mov    -0xc(%ebp),%eax
c010a38b:	eb 0d                	jmp    c010a39a <do_fork+0x136>

bad_fork_cleanup_kstack:
    put_kstack(proc);
bad_fork_cleanup_proc:
    kfree(proc);
c010a38d:	8b 45 f0             	mov    -0x10(%ebp),%eax
c010a390:	89 04 24             	mov    %eax,(%esp)
c010a393:	e8 4d bb ff ff       	call   c0105ee5 <kfree>
    goto fork_out;
c010a398:	eb ee                	jmp    c010a388 <do_fork+0x124>
}
c010a39a:	c9                   	leave  
c010a39b:	c3                   	ret    
...
c010a39f:	83 ec 18             	sub    $0x18,%esp
    panic("process exit!!.\n");
c010a3a2:	c7 44 24 08 c9 d5 10 	movl   $0xc010d5c9,0x8(%esp)
c010a3a9:	c0 
c010a3aa:	c7 44 24 04 64 01 00 	movl   $0x164,0x4(%esp)
c010a3b1:	00 
c010a3b2:	c7 04 24 b5 d5 10 c0 	movl   $0xc010d5b5,(%esp)
c010a3b9:	e8 ae 7d ff ff       	call   c010216c <__panic>
...
c010a3c1:	83 ec 18             	sub    $0x18,%esp
    cprintf("this initproc, pid = %d, name = \"%s\"\n", current->pid, get_proc_name(current));
c010a3c4:	a1 48 c0 12 c0       	mov    0xc012c048,%eax
c010a3c9:	89 04 24             	mov    %eax,(%esp)
c010a3cc:	e8 f5 f9 ff ff       	call   c0109dc6 <get_proc_name>
c010a3d1:	8b 15 48 c0 12 c0    	mov    0xc012c048,%edx
c010a3d7:	8b 52 04             	mov    0x4(%edx),%edx
c010a3da:	89 44 24 08          	mov    %eax,0x8(%esp)
c010a3de:	89 54 24 04          	mov    %edx,0x4(%esp)
c010a3e2:	c7 04 24 dc d5 10 c0 	movl   $0xc010d5dc,(%esp)
c010a3e9:	e8 f4 73 ff ff       	call   c01017e2 <cprintf>
    cprintf("To U: \"%s\".\n", (const char *)arg);
c010a3ee:	8b 45 08             	mov    0x8(%ebp),%eax
c010a3f1:	89 44 24 04          	mov    %eax,0x4(%esp)
c010a3f5:	c7 04 24 02 d6 10 c0 	movl   $0xc010d602,(%esp)
c010a3fc:	e8 e1 73 ff ff       	call   c01017e2 <cprintf>
    cprintf("To U: \"en.., Bye, Bye. :)\"\n");
c010a401:	c7 04 24 0f d6 10 c0 	movl   $0xc010d60f,(%esp)
c010a408:	e8 d5 73 ff ff       	call   c01017e2 <cprintf>
    return 0;
...
c010a41a:	c7 45 ec 70 e1 12 c0 	movl   $0xc012e170,-0x14(%ebp)
 * list_init - initialize a new entry
 * @elm:        new entry to be initialized
 * */
static inline void
list_init(list_entry_t *elm) {
    elm->prev = elm->next = elm;
c010a421:	8b 45 ec             	mov    -0x14(%ebp),%eax
c010a424:	8b 55 ec             	mov    -0x14(%ebp),%edx
c010a427:	89 50 04             	mov    %edx,0x4(%eax)
c010a42a:	8b 45 ec             	mov    -0x14(%ebp),%eax
c010a42d:	8b 50 04             	mov    0x4(%eax),%edx
c010a430:	8b 45 ec             	mov    -0x14(%ebp),%eax
c010a433:	89 10                	mov    %edx,(%eax)
    int i;

    list_init(&proc_list);
    for (i = 0; i < HASH_LIST_SIZE; i ++) {
c010a435:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
c010a43c:	eb 26                	jmp    c010a464 <proc_init+0x50>
        list_init(hash_list + i);
c010a43e:	8b 45 f4             	mov    -0xc(%ebp),%eax
c010a441:	c1 e0 03             	shl    $0x3,%eax
c010a444:	05 60 c0 12 c0       	add    $0xc012c060,%eax
c010a449:	89 45 e8             	mov    %eax,-0x18(%ebp)
...
proc_init(void) {
    ...
    list_init(&proc_list);
    for (i = 0; i < HASH_LIST_SIZE; i ++) {
c010a460:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
c010a464:	81 7d f4 ff 03 00 00 	cmpl   $0x3ff,-0xc(%ebp)
c010a46b:	7e d1                	jle    c010a43e <proc_init+0x2a>
        list_init(hash_list + i);
    }

    if ((idleproc = alloc_proc()) == NULL) {
c010a46d:	e8 4c f8 ff ff       	call   c0109cbe <alloc_proc>
c010a472:	a3 40 c0 12 c0       	mov    %eax,0xc012c040
c010a477:	a1 40 c0 12 c0       	mov    0xc012c040,%eax
c010a47c:	85 c0                	test   %eax,%eax
c010a47e:	75 1c                	jne    c010a49c <proc_init+0x88>
        panic("cannot alloc idleproc.\n");
c010a480:	c7 44 24 08 2b d6 10 	movl   $0xc010d62b,0x8(%esp)
c010a487:	c0 
c010a488:	c7 44 24 04 7c 01 00 	movl   $0x17c,0x4(%esp)
c010a48f:	00 
c010a490:	c7 04 24 b5 d5 10 c0 	movl   $0xc010d5b5,(%esp)
c010a497:	e8 d0 7c ff ff       	call   c010216c <__panic>
    }

    idleproc->pid = 0;
c010a49c:	a1 40 c0 12 c0       	mov    0xc012c040,%eax
c010a4a1:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
    idleproc->state = PROC_RUNNABLE;
c010a4a8:	a1 40 c0 12 c0       	mov    0xc012c040,%eax
c010a4ad:	c7 00 02 00 00 00    	movl   $0x2,(%eax)
    idleproc->kstack = (uintptr_t)bootstack;
c010a4b3:	a1 40 c0 12 c0       	mov    0xc012c040,%eax
c010a4b8:	ba 00 60 12 c0       	mov    $0xc0126000,%edx
c010a4bd:	89 50 0c             	mov    %edx,0xc(%eax)
    idleproc->need_resched = 1;
c010a4c0:	a1 40 c0 12 c0       	mov    0xc012c040,%eax
c010a4c5:	c7 40 10 01 00 00 00 	movl   $0x1,0x10(%eax)
    set_proc_name(idleproc, "idle");
c010a4cc:	a1 40 c0 12 c0       	mov    0xc012c040,%eax
c010a4d1:	c7 44 24 04 43 d6 10 	movl   $0xc010d643,0x4(%esp)
c010a4d8:	c0 
c010a4d9:	89 04 24             	mov    %eax,(%esp)
c010a4dc:	e8 a2 f8 ff ff       	call   c0109d83 <set_proc_name>
    nr_process ++;
c010a4e1:	a1 60 e0 12 c0       	mov    0xc012e060,%eax
c010a4e6:	83 c0 01             	add    $0x1,%eax
c010a4e9:	a3 60 e0 12 c0       	mov    %eax,0xc012e060

    current = idleproc;
c010a4ee:	a1 40 c0 12 c0       	mov    0xc012c040,%eax
c010a4f3:	a3 48 c0 12 c0       	mov    %eax,0xc012c048

    int pid = kernel_thread(init_main, "Hello world!!", 0);
c010a4f8:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
c010a4ff:	00 
c010a500:	c7 44 24 04 48 d6 10 	movl   $0xc010d648,0x4(%esp)
c010a507:	c0 
c010a508:	c7 04 24 be a3 10 c0 	movl   $0xc010a3be,(%esp)
c010a50f:	e8 67 fb ff ff       	call   c010a07b <kernel_thread>
c010a514:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if (pid <= 0) {
c010a517:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
c010a51b:	7f 1c                	jg     c010a539 <proc_init+0x125>
        panic("create init_main failed.\n");
c010a51d:	c7 44 24 08 56 d6 10 	movl   $0xc010d656,0x8(%esp)
c010a524:	c0 
c010a525:	c7 44 24 04 8a 01 00 	movl   $0x18a,0x4(%esp)
c010a52c:	00 
c010a52d:	c7 04 24 b5 d5 10 c0 	movl   $0xc010d5b5,(%esp)
c010a534:	e8 33 7c ff ff       	call   c010216c <__panic>
    }

    initproc = find_proc(pid);
c010a539:	8b 45 f0             	mov    -0x10(%ebp),%eax
c010a53c:	89 04 24             	mov    %eax,(%esp)
c010a53f:	e8 c5 fa ff ff       	call   c010a009 <find_proc>
c010a544:	a3 44 c0 12 c0       	mov    %eax,0xc012c044
    set_proc_name(initproc, "init");
c010a549:	a1 44 c0 12 c0       	mov    0xc012c044,%eax
c010a54e:	c7 44 24 04 70 d6 10 	movl   $0xc010d670,0x4(%esp)
c010a555:	c0 
c010a556:	89 04 24             	mov    %eax,(%esp)
c010a559:	e8 25 f8 ff ff       	call   c0109d83 <set_proc_name>

    assert(idleproc != NULL && idleproc->pid == 0);
c010a55e:	a1 40 c0 12 c0       	mov    0xc012c040,%eax
c010a563:	85 c0                	test   %eax,%eax
c010a565:	74 0c                	je     c010a573 <proc_init+0x15f>
c010a567:	a1 40 c0 12 c0       	mov    0xc012c040,%eax
c010a56c:	8b 40 04             	mov    0x4(%eax),%eax
c010a56f:	85 c0                	test   %eax,%eax
c010a571:	74 24                	je     c010a597 <proc_init+0x183>
c010a573:	c7 44 24 0c 78 d6 10 	movl   $0xc010d678,0xc(%esp)
c010a57a:	c0 
c010a57b:	c7 44 24 08 a0 d5 10 	movl   $0xc010d5a0,0x8(%esp)
c010a582:	c0 
c010a583:	c7 44 24 04 90 01 00 	movl   $0x190,0x4(%esp)
c010a58a:	00 
c010a58b:	c7 04 24 b5 d5 10 c0 	movl   $0xc010d5b5,(%esp)
c010a592:	e8 d5 7b ff ff       	call   c010216c <__panic>
    assert(initproc != NULL && initproc->pid == 1);
c010a597:	a1 44 c0 12 c0       	mov    0xc012c044,%eax
c010a59c:	85 c0                	test   %eax,%eax
c010a59e:	74 0d                	je     c010a5ad <proc_init+0x199>
c010a5a0:	a1 44 c0 12 c0       	mov    0xc012c044,%eax
c010a5a5:	8b 40 04             	mov    0x4(%eax),%eax
c010a5a8:	83 f8 01             	cmp    $0x1,%eax
c010a5ab:	74 24                	je     c010a5d1 <proc_init+0x1bd>
c010a5ad:	c7 44 24 0c a0 d6 10 	movl   $0xc010d6a0,0xc(%esp)
c010a5b4:	c0 
c010a5b5:	c7 44 24 08 a0 d5 10 	movl   $0xc010d5a0,0x8(%esp)
c010a5bc:	c0 
c010a5bd:	c7 44 24 04 91 01 00 	movl   $0x191,0x4(%esp)
c010a5c4:	00 
c010a5c5:	c7 04 24 b5 d5 10 c0 	movl   $0xc010d5b5,(%esp)
c010a5cc:	e8 9b 7b ff ff       	call   c010216c <__panic>
}
c010a5d1:	c9                   	leave  
c010a5d2:	c3                   	ret    
...
c010a5d4:	89 e5                	mov    %esp,%ebp
c010a5d6:	83 ec 08             	sub    $0x8,%esp
    while (1) {
        if (current->need_resched) {
c010a5d9:	a1 48 c0 12 c0       	mov    0xc012c048,%eax
c010a5de:	8b 40 10             	mov    0x10(%eax),%eax
c010a5e1:	85 c0                	test   %eax,%eax
c010a5e3:	74 07                	je     c010a5ec <cpu_idle+0x19>
            schedule();
c010a5e5:	e8 c1 00 00 00       	call   c010a6ab <schedule>
        }
    }
c010a5ea:	eb ed                	jmp    c010a5d9 <cpu_idle+0x6>
c010a5ec:	eb eb                	jmp    c010a5d9 <cpu_idle+0x6>
...
c010a5ee:	8b 44 24 04          	mov    0x4(%esp),%eax
    popl 0(%eax)                # save eip !popl
c010a5f2:	8f 00                	popl   (%eax)
    movl %esp, 4(%eax)
c010a5f4:	89 60 04             	mov    %esp,0x4(%eax)
    movl %ebx, 8(%eax)
c010a5f7:	89 58 08             	mov    %ebx,0x8(%eax)
    movl %ecx, 12(%eax)
c010a5fa:	89 48 0c             	mov    %ecx,0xc(%eax)
    movl %edx, 16(%eax)
c010a5fd:	89 50 10             	mov    %edx,0x10(%eax)
    movl %esi, 20(%eax)
c010a600:	89 70 14             	mov    %esi,0x14(%eax)
    movl %edi, 24(%eax)
c010a603:	89 78 18             	mov    %edi,0x18(%eax)
    movl %ebp, 28(%eax)
c010a606:	89 68 1c             	mov    %ebp,0x1c(%eax)

    # restore to's registers
    movl 4(%esp), %eax          # not 8(%esp): popped return address already
c010a609:	8b 44 24 04          	mov    0x4(%esp),%eax
                                # eax now points to to
    movl 28(%eax), %ebp
c010a60d:	8b 68 1c             	mov    0x1c(%eax),%ebp
    movl 24(%eax), %edi
c010a610:	8b 78 18             	mov    0x18(%eax),%edi
    movl 20(%eax), %esi
c010a613:	8b 70 14             	mov    0x14(%eax),%esi
    movl 16(%eax), %edx
c010a616:	8b 50 10             	mov    0x10(%eax),%edx
    movl 12(%eax), %ecx
c010a619:	8b 48 0c             	mov    0xc(%eax),%ecx
    movl 8(%eax), %ebx
c010a61c:	8b 58 08             	mov    0x8(%eax),%ebx
    movl 4(%eax), %esp
c010a61f:	8b 60 04             	mov    0x4(%eax),%esp

    pushl 0(%eax)               # push eip
c010a622:	ff 30                	pushl  (%eax)

    ret
c010a624:	c3                   	ret    

c010a625 <__intr_save>:
#include <x86.h>
#include <intr.h>
#include <mmu.h>
...
static inline bool
__intr_save(void) {
c010a625:	55                   	push   %ebp
c010a626:	89 e5                	mov    %esp,%ebp
c010a628:	83 ec 18             	sub    $0x18,%esp
}
...
c010a62b:	9c                   	pushf  
c010a62c:	58                   	pop    %eax
c010a62d:	89 45 f4             	mov    %eax,-0xc(%ebp)
    return eflags;
c010a630:	8b 45 f4             	mov    -0xc(%ebp),%eax
    if (read_eflags() & FL_IF) {
c010a633:	25 00 02 00 00       	and    $0x200,%eax
c010a638:	85 c0                	test   %eax,%eax
c010a63a:	74 0c                	je     c010a648 <__intr_save+0x23>
        intr_disable();
c010a63c:	e8 94 8d ff ff       	call   c01033d5 <intr_disable>
        return 1;
c010a641:	b8 01 00 00 00       	mov    $0x1,%eax
c010a646:	eb 05                	jmp    c010a64d <__intr_save+0x28>
    }
    return 0;
c010a648:	b8 00 00 00 00       	mov    $0x0,%eax
}
c010a64d:	c9                   	leave  
c010a64e:	c3                   	ret    

c010a64f <__intr_restore>:

static inline void
__intr_restore(bool flag) {
c010a64f:	55                   	push   %ebp
c010a650:	89 e5                	mov    %esp,%ebp
c010a652:	83 ec 08             	sub    $0x8,%esp
    if (flag) {
c010a655:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
c010a659:	74 05                	je     c010a660 <__intr_restore+0x11>
        intr_enable();
c010a65b:	e8 6f 8d ff ff       	call   c01033cf <intr_enable>
    }
}
c010a660:	c9                   	leave  
c010a661:	c3                   	ret    

c010a662 <wakeup_proc>:
#include <proc.h>
#include <sched.h>
#include <assert.h>
...
c010a665:	83 ec 18             	sub    $0x18,%esp
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
c010a668:	8b 45 08             	mov    0x8(%ebp),%eax
c010a66b:	8b 00                	mov    (%eax),%eax
c010a66d:	83 f8 03             	cmp    $0x3,%eax
c010a670:	74 0a                	je     c010a67c <wakeup_proc+0x1a>
c010a672:	8b 45 08             	mov    0x8(%ebp),%eax
c010a675:	8b 00                	mov    (%eax),%eax
c010a677:	83 f8 02             	cmp    $0x2,%eax
c010a67a:	75 24                	jne    c010a6a0 <wakeup_proc+0x3e>
c010a67c:	c7 44 24 0c c8 d6 10 	movl   $0xc010d6c8,0xc(%esp)
c010a683:	c0 
c010a684:	c7 44 24 08 03 d7 10 	movl   $0xc010d703,0x8(%esp)
c010a68b:	c0 
c010a68c:	c7 44 24 04 09 00 00 	movl   $0x9,0x4(%esp)
c010a693:	00 
c010a694:	c7 04 24 18 d7 10 c0 	movl   $0xc010d718,(%esp)
c010a69b:	e8 cc 7a ff ff       	call   c010216c <__panic>
    proc->state = PROC_RUNNABLE;
c010a6a0:	8b 45 08             	mov    0x8(%ebp),%eax
c010a6a3:	c7 00 02 00 00 00    	movl   $0x2,(%eax)
}
c010a6a9:	c9                   	leave  
c010a6aa:	c3                   	ret    
...
void
schedule(void) {
c010a6ab:	55                   	push   %ebp
c010a6ac:	89 e5                	mov    %esp,%ebp
c010a6ae:	83 ec 38             	sub    $0x38,%esp
    bool intr_flag;
    list_entry_t *le, *last;
    struct proc_struct *next = NULL;
c010a6b1:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    local_intr_save(intr_flag);
c010a6b8:	e8 68 ff ff ff       	call   c010a625 <__intr_save>
c010a6bd:	89 45 ec             	mov    %eax,-0x14(%ebp)
    {
        current->need_resched = 0;
c010a6c0:	a1 48 c0 12 c0       	mov    0xc012c048,%eax
c010a6c5:	c7 40 10 00 00 00 00 	movl   $0x0,0x10(%eax)
        last = (current == idleproc) ? &proc_list : &(current->list_link);
c010a6cc:	8b 15 48 c0 12 c0    	mov    0xc012c048,%edx
c010a6d2:	a1 40 c0 12 c0       	mov    0xc012c040,%eax
c010a6d7:	39 c2                	cmp    %eax,%edx
c010a6d9:	74 0a                	je     c010a6e5 <schedule+0x3a>
c010a6db:	a1 48 c0 12 c0       	mov    0xc012c048,%eax
c010a6e0:	83 c0 58             	add    $0x58,%eax
c010a6e3:	eb 05                	jmp    c010a6ea <schedule+0x3f>
c010a6e5:	b8 70 e1 12 c0       	mov    $0xc012e170,%eax
c010a6ea:	89 45 e8             	mov    %eax,-0x18(%ebp)
        le = last;
c010a6ed:	8b 45 e8             	mov    -0x18(%ebp),%eax
c010a6f0:	89 45 f4             	mov    %eax,-0xc(%ebp)
c010a6f3:	8b 45 f4             	mov    -0xc(%ebp),%eax
c010a6f6:	89 45 e4             	mov    %eax,-0x1c(%ebp)
 * list_next - get the next entry
 * @listelm:    the list head
 **/
static inline list_entry_t *
list_next(list_entry_t *listelm) {
    return listelm->next;
c010a6f9:	8b 45 e4             	mov    -0x1c(%ebp),%eax
c010a6fc:	8b 40 04             	mov    0x4(%eax),%eax
        do {
            if ((le = list_next(le)) != &proc_list) {
c010a6ff:	89 45 f4             	mov    %eax,-0xc(%ebp)
c010a702:	81 7d f4 70 e1 12 c0 	cmpl   $0xc012e170,-0xc(%ebp)
c010a709:	74 15                	je     c010a720 <schedule+0x75>
                next = le2proc(le, list_link);
c010a70b:	8b 45 f4             	mov    -0xc(%ebp),%eax
c010a70e:	83 e8 58             	sub    $0x58,%eax
c010a711:	89 45 f0             	mov    %eax,-0x10(%ebp)
                if (next->state == PROC_RUNNABLE) {
c010a714:	8b 45 f0             	mov    -0x10(%ebp),%eax
c010a717:	8b 00                	mov    (%eax),%eax
c010a719:	83 f8 02             	cmp    $0x2,%eax
c010a71c:	75 02                	jne    c010a720 <schedule+0x75>
                    break;
c010a71e:	eb 08                	jmp    c010a728 <schedule+0x7d>
                }
            }
        } while (le != last);
c010a720:	8b 45 f4             	mov    -0xc(%ebp),%eax
c010a723:	3b 45 e8             	cmp    -0x18(%ebp),%eax
c010a726:	75 cb                	jne    c010a6f3 <schedule+0x48>
        if (next == NULL || next->state != PROC_RUNNABLE) {
c010a728:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
c010a72c:	74 0a                	je     c010a738 <schedule+0x8d>
c010a72e:	8b 45 f0             	mov    -0x10(%ebp),%eax
c010a731:	8b 00                	mov    (%eax),%eax
c010a733:	83 f8 02             	cmp    $0x2,%eax
c010a736:	74 08                	je     c010a740 <schedule+0x95>
            next = idleproc;
c010a738:	a1 40 c0 12 c0       	mov    0xc012c040,%eax
c010a73d:	89 45 f0             	mov    %eax,-0x10(%ebp)
        }
        next->runs ++;
c010a740:	8b 45 f0             	mov    -0x10(%ebp),%eax
c010a743:	8b 40 08             	mov    0x8(%eax),%eax
c010a746:	8d 50 01             	lea    0x1(%eax),%edx
c010a749:	8b 45 f0             	mov    -0x10(%ebp),%eax
c010a74c:	89 50 08             	mov    %edx,0x8(%eax)
        if (next != current) {
c010a74f:	a1 48 c0 12 c0       	mov    0xc012c048,%eax
c010a754:	39 45 f0             	cmp    %eax,-0x10(%ebp)
c010a757:	74 0b                	je     c010a764 <schedule+0xb9>
            proc_run(next);
c010a759:	8b 45 f0             	mov    -0x10(%ebp),%eax
c010a75c:	89 04 24             	mov    %eax,(%esp)
c010a75f:	e8 9c f7 ff ff       	call   c0109f00 <proc_run>
        }
    }
    local_intr_restore(intr_flag);
c010a764:	8b 45 ec             	mov    -0x14(%ebp),%eax
c010a767:	89 04 24             	mov    %eax,(%esp)
c010a76a:	e8 e0 fe ff ff       	call   c010a64f <__intr_restore>
}
c010a76f:	c9                   	leave  
c010a770:	c3                   	ret    
...
c010a771:	55                   	push   %ebp
c010a772:	89 e5                	mov    %esp,%ebp
c010a774:	83 ec 10             	sub    $0x10,%esp
    uint32_t hash = val * GOLDEN_RATIO_PRIME_32;
c010a777:	8b 45 08             	mov    0x8(%ebp),%eax
c010a77a:	69 c0 01 00 37 9e    	imul   $0x9e370001,%eax,%eax
c010a780:	89 45 fc             	mov    %eax,-0x4(%ebp)
    return (hash >> (32 - bits));
c010a783:	b8 20 00 00 00       	mov    $0x20,%eax
c010a788:	2b 45 0c             	sub    0xc(%ebp),%eax
c010a78b:	8b 55 fc             	mov    -0x4(%ebp),%edx
c010a78e:	89 c1                	mov    %eax,%ecx
c010a790:	d3 ea                	shr    %cl,%edx
c010a792:	89 d0                	mov    %edx,%eax
}
c010a794:	c9                   	leave  
c010a795:	c3                   	ret    
...
c010a799:	83 ec 58             	sub    $0x58,%esp
c010a79c:	8b 45 10             	mov    0x10(%ebp),%eax
c010a79f:	89 45 d0             	mov    %eax,-0x30(%ebp)
c010a7a2:	8b 45 14             	mov    0x14(%ebp),%eax
c010a7a5:	89 45 d4             	mov    %eax,-0x2c(%ebp)
    unsigned long long result = num;
c010a7a8:	8b 45 d0             	mov    -0x30(%ebp),%eax
c010a7ab:	8b 55 d4             	mov    -0x2c(%ebp),%edx
c010a7ae:	89 45 e8             	mov    %eax,-0x18(%ebp)
c010a7b1:	89 55 ec             	mov    %edx,-0x14(%ebp)
    unsigned mod = do_div(result, base);
c010a7b4:	8b 45 18             	mov    0x18(%ebp),%eax
c010a7b7:	89 45 e4             	mov    %eax,-0x1c(%ebp)
c010a7ba:	8b 45 e8             	mov    -0x18(%ebp),%eax
c010a7bd:	8b 55 ec             	mov    -0x14(%ebp),%edx
c010a7c0:	89 45 e0             	mov    %eax,-0x20(%ebp)
c010a7c3:	89 55 f0             	mov    %edx,-0x10(%ebp)
c010a7c6:	8b 45 f0             	mov    -0x10(%ebp),%eax
c010a7c9:	89 45 f4             	mov    %eax,-0xc(%ebp)
c010a7cc:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
c010a7d0:	74 1c                	je     c010a7ee <printnum+0x58>
c010a7d2:	8b 45 f0             	mov    -0x10(%ebp),%eax
c010a7d5:	ba 00 00 00 00       	mov    $0x0,%edx
c010a7da:	f7 75 e4             	divl   -0x1c(%ebp)
c010a7dd:	89 55 f4             	mov    %edx,-0xc(%ebp)
c010a7e0:	8b 45 f0             	mov    -0x10(%ebp),%eax
c010a7e3:	ba 00 00 00 00       	mov    $0x0,%edx
c010a7e8:	f7 75 e4             	divl   -0x1c(%ebp)
c010a7eb:	89 45 f0             	mov    %eax,-0x10(%ebp)
c010a7ee:	8b 45 e0             	mov    -0x20(%ebp),%eax
c010a7f1:	8b 55 f4             	mov    -0xc(%ebp),%edx
c010a7f4:	f7 75 e4             	divl   -0x1c(%ebp)
c010a7f7:	89 45 e0             	mov    %eax,-0x20(%ebp)
c010a7fa:	89 55 dc             	mov    %edx,-0x24(%ebp)
c010a7fd:	8b 45 e0             	mov    -0x20(%ebp),%eax
c010a800:	8b 55 f0             	mov    -0x10(%ebp),%edx
c010a803:	89 45 e8             	mov    %eax,-0x18(%ebp)
c010a806:	89 55 ec             	mov    %edx,-0x14(%ebp)
c010a809:	8b 45 dc             	mov    -0x24(%ebp),%eax
c010a80c:	89 45 d8             	mov    %eax,-0x28(%ebp)

    // first recursively print all preceding (more significant) digits
    if (num >= base) {
c010a80f:	8b 45 18             	mov    0x18(%ebp),%eax
c010a812:	ba 00 00 00 00       	mov    $0x0,%edx
c010a817:	3b 55 d4             	cmp    -0x2c(%ebp),%edx
c010a81a:	77 56                	ja     c010a872 <printnum+0xdc>
c010a81c:	3b 55 d4             	cmp    -0x2c(%ebp),%edx
c010a81f:	72 05                	jb     c010a826 <printnum+0x90>
c010a821:	3b 45 d0             	cmp    -0x30(%ebp),%eax
c010a824:	77 4c                	ja     c010a872 <printnum+0xdc>
        printnum(putch, putdat, result, base, width - 1, padc);
c010a826:	8b 45 1c             	mov    0x1c(%ebp),%eax
c010a829:	8d 50 ff             	lea    -0x1(%eax),%edx
c010a82c:	8b 45 20             	mov    0x20(%ebp),%eax
c010a82f:	89 44 24 18          	mov    %eax,0x18(%esp)
c010a833:	89 54 24 14          	mov    %edx,0x14(%esp)
c010a837:	8b 45 18             	mov    0x18(%ebp),%eax
c010a83a:	89 44 24 10          	mov    %eax,0x10(%esp)
c010a83e:	8b 45 e8             	mov    -0x18(%ebp),%eax
c010a841:	8b 55 ec             	mov    -0x14(%ebp),%edx
c010a844:	89 44 24 08          	mov    %eax,0x8(%esp)
c010a848:	89 54 24 0c          	mov    %edx,0xc(%esp)
c010a84c:	8b 45 0c             	mov    0xc(%ebp),%eax
c010a84f:	89 44 24 04          	mov    %eax,0x4(%esp)
c010a853:	8b 45 08             	mov    0x8(%ebp),%eax
c010a856:	89 04 24             	mov    %eax,(%esp)
c010a859:	e8 38 ff ff ff       	call   c010a796 <printnum>
c010a85e:	eb 1c                	jmp    c010a87c <printnum+0xe6>
    } else {
        // print any needed pad characters before first digit
        while (-- width > 0)
            putch(padc, putdat);
c010a860:	8b 45 0c             	mov    0xc(%ebp),%eax
c010a863:	89 44 24 04          	mov    %eax,0x4(%esp)
c010a867:	8b 45 20             	mov    0x20(%ebp),%eax
c010a86a:	89 04 24             	mov    %eax,(%esp)
c010a86d:	8b 45 08             	mov    0x8(%ebp),%eax
c010a870:	ff d0                	call   *%eax
    // first recursively print all preceding (more significant) digits
    if (num >= base) {
        printnum(putch, putdat, result, base, width - 1, padc);
    } else {
        // print any needed pad characters before first digit
        while (-- width > 0)
c010a872:	83 6d 1c 01          	subl   $0x1,0x1c(%ebp)
c010a876:	83 7d 1c 00          	cmpl   $0x0,0x1c(%ebp)
c010a87a:	7f e4                	jg     c010a860 <printnum+0xca>
            putch(padc, putdat);
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
c010a87c:	8b 45 d8             	mov    -0x28(%ebp),%eax
c010a87f:	05 b0 d7 10 c0       	add    $0xc010d7b0,%eax
c010a884:	0f b6 00             	movzbl (%eax),%eax
c010a887:	0f be c0             	movsbl %al,%eax
c010a88a:	8b 55 0c             	mov    0xc(%ebp),%edx
c010a88d:	89 54 24 04          	mov    %edx,0x4(%esp)
c010a891:	89 04 24             	mov    %eax,(%esp)
c010a894:	8b 45 08             	mov    0x8(%ebp),%eax
c010a897:	ff d0                	call   *%eax
}
c010a899:	c9                   	leave  
c010a89a:	c3                   	ret    
...
c010a89b:	55                   	push   %ebp
c010a89c:	89 e5                	mov    %esp,%ebp
    if (lflag >= 2) {
c010a89e:	83 7d 0c 01          	cmpl   $0x1,0xc(%ebp)
c010a8a2:	7e 14                	jle    c010a8b8 <getuint+0x1d>
        return va_arg(*ap, unsigned long long);
c010a8a4:	8b 45 08             	mov    0x8(%ebp),%eax
c010a8a7:	8b 00                	mov    (%eax),%eax
c010a8a9:	8d 48 08             	lea    0x8(%eax),%ecx
c010a8ac:	8b 55 08             	mov    0x8(%ebp),%edx
c010a8af:	89 0a                	mov    %ecx,(%edx)
c010a8b1:	8b 50 04             	mov    0x4(%eax),%edx
c010a8b4:	8b 00                	mov    (%eax),%eax
c010a8b6:	eb 30                	jmp    c010a8e8 <getuint+0x4d>
    }
    else if (lflag) {
c010a8b8:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
c010a8bc:	74 16                	je     c010a8d4 <getuint+0x39>
        return va_arg(*ap, unsigned long);
c010a8be:	8b 45 08             	mov    0x8(%ebp),%eax
c010a8c1:	8b 00                	mov    (%eax),%eax
c010a8c3:	8d 48 04             	lea    0x4(%eax),%ecx
c010a8c6:	8b 55 08             	mov    0x8(%ebp),%edx
c010a8c9:	89 0a                	mov    %ecx,(%edx)
c010a8cb:	8b 00                	mov    (%eax),%eax
c010a8cd:	ba 00 00 00 00       	mov    $0x0,%edx
c010a8d2:	eb 14                	jmp    c010a8e8 <getuint+0x4d>
    }
    else {
        return va_arg(*ap, unsigned int);
c010a8d4:	8b 45 08             	mov    0x8(%ebp),%eax
c010a8d7:	8b 00                	mov    (%eax),%eax
c010a8d9:	8d 48 04             	lea    0x4(%eax),%ecx
c010a8dc:	8b 55 08             	mov    0x8(%ebp),%edx
c010a8df:	89 0a                	mov    %ecx,(%edx)
c010a8e1:	8b 00                	mov    (%eax),%eax
c010a8e3:	ba 00 00 00 00       	mov    $0x0,%edx
    }
}
c010a8e8:	5d                   	pop    %ebp
c010a8e9:	c3                   	ret    
...
c010a8ea:	55                   	push   %ebp
c010a8eb:	89 e5                	mov    %esp,%ebp
    if (lflag >= 2) {
c010a8ed:	83 7d 0c 01          	cmpl   $0x1,0xc(%ebp)
c010a8f1:	7e 14                	jle    c010a907 <getint+0x1d>
        return va_arg(*ap, long long);
c010a8f3:	8b 45 08             	mov    0x8(%ebp),%eax
c010a8f6:	8b 00                	mov    (%eax),%eax
c010a8f8:	8d 48 08             	lea    0x8(%eax),%ecx
c010a8fb:	8b 55 08             	mov    0x8(%ebp),%edx
c010a8fe:	89 0a                	mov    %ecx,(%edx)
c010a900:	8b 50 04             	mov    0x4(%eax),%edx
c010a903:	8b 00                	mov    (%eax),%eax
c010a905:	eb 28                	jmp    c010a92f <getint+0x45>
    }
    else if (lflag) {
c010a907:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
c010a90b:	74 12                	je     c010a91f <getint+0x35>
        return va_arg(*ap, long);
c010a90d:	8b 45 08             	mov    0x8(%ebp),%eax
c010a910:	8b 00                	mov    (%eax),%eax
c010a912:	8d 48 04             	lea    0x4(%eax),%ecx
c010a915:	8b 55 08             	mov    0x8(%ebp),%edx
c010a918:	89 0a                	mov    %ecx,(%edx)
c010a91a:	8b 00                	mov    (%eax),%eax
c010a91c:	99                   	cltd   
c010a91d:	eb 10                	jmp    c010a92f <getint+0x45>
    }
    else {
        return va_arg(*ap, int);
c010a91f:	8b 45 08             	mov    0x8(%ebp),%eax
c010a922:	8b 00                	mov    (%eax),%eax
c010a924:	8d 48 04             	lea    0x4(%eax),%ecx
c010a927:	8b 55 08             	mov    0x8(%ebp),%edx
c010a92a:	89 0a                	mov    %ecx,(%edx)
c010a92c:	8b 00                	mov    (%eax),%eax
c010a92e:	99                   	cltd   
    }
}
c010a92f:	5d                   	pop    %ebp
...
c010a934:	83 ec 28             	sub    $0x28,%esp
    ...
    va_start(ap, fmt);
c010a937:	8d 45 14             	lea    0x14(%ebp),%eax
c010a93a:	89 45 f4             	mov    %eax,-0xc(%ebp)
    vprintfmt(putch, putdat, fmt, ap);
c010a93d:	8b 45 f4             	mov    -0xc(%ebp),%eax
c010a940:	89 44 24 0c          	mov    %eax,0xc(%esp)
c010a944:	8b 45 10             	mov    0x10(%ebp),%eax
c010a947:	89 44 24 08          	mov    %eax,0x8(%esp)
c010a94b:	8b 45 0c             	mov    0xc(%ebp),%eax
c010a94e:	89 44 24 04          	mov    %eax,0x4(%esp)
c010a952:	8b 45 08             	mov    0x8(%ebp),%eax
c010a955:	89 04 24             	mov    %eax,(%esp)
c010a958:	e8 02 00 00 00       	call   c010a95f <vprintfmt>
    va_end(ap);
}
c010a95d:	c9                   	leave  
c010a95e:	c3                   	ret    
...
c010a95f:	55                   	push   %ebp
c010a960:	89 e5                	mov    %esp,%ebp
c010a962:	56                   	push   %esi
c010a963:	53                   	push   %ebx
c010a964:	83 ec 40             	sub    $0x40,%esp
    register int ch, err;
...
c010a967:	eb 18                	jmp    c010a981 <vprintfmt+0x22>
            if (ch == '\0') {
c010a969:	85 db                	test   %ebx,%ebx
c010a96b:	75 05                	jne    c010a972 <vprintfmt+0x13>
                return;
c010a96d:	e9 d1 03 00 00       	jmp    c010ad43 <vprintfmt+0x3e4>
            }
            putch(ch, putdat);
c010a972:	8b 45 0c             	mov    0xc(%ebp),%eax
c010a975:	89 44 24 04          	mov    %eax,0x4(%esp)
c010a979:	89 1c 24             	mov    %ebx,(%esp)
c010a97c:	8b 45 08             	mov    0x8(%ebp),%eax
c010a97f:	ff d0                	call   *%eax
    register int ch, err;
    unsigned long long num;
    int base, width, precision, lflag, altflag;
...
c010a987:	89 55 10             	mov    %edx,0x10(%ebp)
c010a98a:	0f b6 00             	movzbl (%eax),%eax
c010a98d:	0f b6 d8             	movzbl %al,%ebx
c010a990:	83 fb 25             	cmp    $0x25,%ebx
c010a993:	75 d4                	jne    c010a969 <vprintfmt+0xa>
            }
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
c010a995:	c6 45 db 20          	movb   $0x20,-0x25(%ebp)
        width = precision = -1;
c010a999:	c7 45 e4 ff ff ff ff 	movl   $0xffffffff,-0x1c(%ebp)
c010a9a0:	8b 45 e4             	mov    -0x1c(%ebp),%eax
c010a9a3:	89 45 e8             	mov    %eax,-0x18(%ebp)
        lflag = altflag = 0;
c010a9a6:	c7 45 dc 00 00 00 00 	movl   $0x0,-0x24(%ebp)
c010a9ad:	8b 45 dc             	mov    -0x24(%ebp),%eax
c010a9b0:	89 45 e0             	mov    %eax,-0x20(%ebp)

    reswitch:
        switch (ch = *(unsigned char *)fmt ++) {
c010a9b3:	8b 45 10             	mov    0x10(%ebp),%eax
c010a9b6:	8d 50 01             	lea    0x1(%eax),%edx
c010a9b9:	89 55 10             	mov    %edx,0x10(%ebp)
c010a9bc:	0f b6 00             	movzbl (%eax),%eax
c010a9bf:	0f b6 d8             	movzbl %al,%ebx
c010a9c2:	8d 43 dd             	lea    -0x23(%ebx),%eax
c010a9c5:	83 f8 55             	cmp    $0x55,%eax
c010a9c8:	0f 87 44 03 00 00    	ja     c010ad12 <vprintfmt+0x3b3>
c010a9ce:	8b 04 85 d4 d7 10 c0 	mov    -0x3fef282c(,%eax,4),%eax
c010a9d5:	ff e0                	jmp    *%eax

        // flag to pad on the right
        case '-':
            padc = '-';
c010a9d7:	c6 45 db 2d          	movb   $0x2d,-0x25(%ebp)
            goto reswitch;
c010a9db:	eb d6                	jmp    c010a9b3 <vprintfmt+0x54>

        // flag to pad with 0's instead of spaces
        case '0':
            padc = '0';
c010a9dd:	c6 45 db 30          	movb   $0x30,-0x25(%ebp)
            goto reswitch;
c010a9e1:	eb d0                	jmp    c010a9b3 <vprintfmt+0x54>

        // width field
        case '1' ... '9':
            for (precision = 0; ; ++ fmt) {
c010a9e3:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
                precision = precision * 10 + ch - '0';
c010a9ea:	8b 55 e4             	mov    -0x1c(%ebp),%edx
c010a9ed:	89 d0                	mov    %edx,%eax
c010a9ef:	c1 e0 02             	shl    $0x2,%eax
c010a9f2:	01 d0                	add    %edx,%eax
c010a9f4:	01 c0                	add    %eax,%eax
c010a9f6:	01 d8                	add    %ebx,%eax
c010a9f8:	83 e8 30             	sub    $0x30,%eax
c010a9fb:	89 45 e4             	mov    %eax,-0x1c(%ebp)
                ch = *fmt;
c010a9fe:	8b 45 10             	mov    0x10(%ebp),%eax
c010aa01:	0f b6 00             	movzbl (%eax),%eax
c010aa04:	0f be d8             	movsbl %al,%ebx
                if (ch < '0' || ch > '9') {
c010aa07:	83 fb 2f             	cmp    $0x2f,%ebx
c010aa0a:	7e 0b                	jle    c010aa17 <vprintfmt+0xb8>
c010aa0c:	83 fb 39             	cmp    $0x39,%ebx
c010aa0f:	7f 06                	jg     c010aa17 <vprintfmt+0xb8>
            padc = '0';
            goto reswitch;
        ...
        case '1' ... '9':
            for (precision = 0; ; ++ fmt) {
c010aa11:	83 45 10 01          	addl   $0x1,0x10(%ebp)
                precision = precision * 10 + ch - '0';
                ch = *fmt;
                if (ch < '0' || ch > '9') {
                    break;
...
c010aa15:	eb d3                	jmp    c010a9ea <vprintfmt+0x8b>
            goto process_precision;
c010aa17:	eb 33                	jmp    c010aa4c <vprintfmt+0xed>

        case '*':
            precision = va_arg(ap, int);
c010aa19:	8b 45 14             	mov    0x14(%ebp),%eax
c010aa1c:	8d 50 04             	lea    0x4(%eax),%edx
c010aa1f:	89 55 14             	mov    %edx,0x14(%ebp)
c010aa22:	8b 00                	mov    (%eax),%eax
c010aa24:	89 45 e4             	mov    %eax,-0x1c(%ebp)
            goto process_precision;
c010aa27:	eb 23                	jmp    c010aa4c <vprintfmt+0xed>

        case '.':
            if (width < 0)
c010aa29:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
c010aa2d:	79 0c                	jns    c010aa3b <vprintfmt+0xdc>
                width = 0;
c010aa2f:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
            goto reswitch;
c010aa36:	e9 78 ff ff ff       	jmp    c010a9b3 <vprintfmt+0x54>
c010aa3b:	e9 73 ff ff ff       	jmp    c010a9b3 <vprintfmt+0x54>

        case '#':
            altflag = 1;
c010aa40:	c7 45 dc 01 00 00 00 	movl   $0x1,-0x24(%ebp)
            goto reswitch;
c010aa47:	e9 67 ff ff ff       	jmp    c010a9b3 <vprintfmt+0x54>

        process_precision:
            if (width < 0)
c010aa4c:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
c010aa50:	79 12                	jns    c010aa64 <vprintfmt+0x105>
                width = precision, precision = -1;
c010aa52:	8b 45 e4             	mov    -0x1c(%ebp),%eax
c010aa55:	89 45 e8             	mov    %eax,-0x18(%ebp)
c010aa58:	c7 45 e4 ff ff ff ff 	movl   $0xffffffff,-0x1c(%ebp)
            goto reswitch;
c010aa5f:	e9 4f ff ff ff       	jmp    c010a9b3 <vprintfmt+0x54>
c010aa64:	e9 4a ff ff ff       	jmp    c010a9b3 <vprintfmt+0x54>

        // long flag (doubled for long long)
        case 'l':
            lflag ++;
c010aa69:	83 45 e0 01          	addl   $0x1,-0x20(%ebp)
            goto reswitch;
c010aa6d:	e9 41 ff ff ff       	jmp    c010a9b3 <vprintfmt+0x54>

        // character
        case 'c':
            putch(va_arg(ap, int), putdat);
c010aa72:	8b 45 14             	mov    0x14(%ebp),%eax
c010aa75:	8d 50 04             	lea    0x4(%eax),%edx
c010aa78:	89 55 14             	mov    %edx,0x14(%ebp)
c010aa7b:	8b 00                	mov    (%eax),%eax
c010aa7d:	8b 55 0c             	mov    0xc(%ebp),%edx
c010aa80:	89 54 24 04          	mov    %edx,0x4(%esp)
c010aa84:	89 04 24             	mov    %eax,(%esp)
c010aa87:	8b 45 08             	mov    0x8(%ebp),%eax
c010aa8a:	ff d0                	call   *%eax
            break;
c010aa8c:	e9 ac 02 00 00       	jmp    c010ad3d <vprintfmt+0x3de>

        // error message
        case 'e':
            err = va_arg(ap, int);
c010aa91:	8b 45 14             	mov    0x14(%ebp),%eax
c010aa94:	8d 50 04             	lea    0x4(%eax),%edx
c010aa97:	89 55 14             	mov    %edx,0x14(%ebp)
c010aa9a:	8b 18                	mov    (%eax),%ebx
            if (err < 0) {
c010aa9c:	85 db                	test   %ebx,%ebx
c010aa9e:	79 02                	jns    c010aaa2 <vprintfmt+0x143>
                err = -err;
c010aaa0:	f7 db                	neg    %ebx
            }
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
c010aaa2:	83 fb 06             	cmp    $0x6,%ebx
c010aaa5:	7f 0b                	jg     c010aab2 <vprintfmt+0x153>
c010aaa7:	8b 34 9d 94 d7 10 c0 	mov    -0x3fef286c(,%ebx,4),%esi
c010aaae:	85 f6                	test   %esi,%esi
c010aab0:	75 23                	jne    c010aad5 <vprintfmt+0x176>
                printfmt(putch, putdat, "error %d", err);
c010aab2:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
c010aab6:	c7 44 24 08 c1 d7 10 	movl   $0xc010d7c1,0x8(%esp)
c010aabd:	c0 
c010aabe:	8b 45 0c             	mov    0xc(%ebp),%eax
c010aac1:	89 44 24 04          	mov    %eax,0x4(%esp)
c010aac5:	8b 45 08             	mov    0x8(%ebp),%eax
c010aac8:	89 04 24             	mov    %eax,(%esp)
c010aacb:	e8 61 fe ff ff       	call   c010a931 <printfmt>
            }
            else {
                printfmt(putch, putdat, "%s", p);
            }
            break;
c010aad0:	e9 68 02 00 00       	jmp    c010ad3d <vprintfmt+0x3de>
            }
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
                printfmt(putch, putdat, "error %d", err);
            }
                ...
                printfmt(putch, putdat, "%s", p);
c010aad5:	89 74 24 0c          	mov    %esi,0xc(%esp)
c010aad9:	c7 44 24 08 ca d7 10 	movl   $0xc010d7ca,0x8(%esp)
c010aae0:	c0 
c010aae1:	8b 45 0c             	mov    0xc(%ebp),%eax
c010aae4:	89 44 24 04          	mov    %eax,0x4(%esp)
c010aae8:	8b 45 08             	mov    0x8(%ebp),%eax
c010aaeb:	89 04 24             	mov    %eax,(%esp)
c010aaee:	e8 3e fe ff ff       	call   c010a931 <printfmt>
            }
            break;
c010aaf3:	e9 45 02 00 00       	jmp    c010ad3d <vprintfmt+0x3de>

        // string
        case 's':
            if ((p = va_arg(ap, char *)) == NULL) {
c010aaf8:	8b 45 14             	mov    0x14(%ebp),%eax
c010aafb:	8d 50 04             	lea    0x4(%eax),%edx
c010aafe:	89 55 14             	mov    %edx,0x14(%ebp)
c010ab01:	8b 30                	mov    (%eax),%esi
c010ab03:	85 f6                	test   %esi,%esi
c010ab05:	75 05                	jne    c010ab0c <vprintfmt+0x1ad>
                p = "(null)";
c010ab07:	be cd d7 10 c0       	mov    $0xc010d7cd,%esi
            }
            if (width > 0 && padc != '-') {
c010ab0c:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
c010ab10:	7e 3e                	jle    c010ab50 <vprintfmt+0x1f1>
c010ab12:	80 7d db 2d          	cmpb   $0x2d,-0x25(%ebp)
c010ab16:	74 38                	je     c010ab50 <vprintfmt+0x1f1>
                for (width -= strnlen(p, precision); width > 0; width --) {
c010ab18:	8b 5d e8             	mov    -0x18(%ebp),%ebx
c010ab1b:	8b 45 e4             	mov    -0x1c(%ebp),%eax
c010ab1e:	89 44 24 04          	mov    %eax,0x4(%esp)
c010ab22:	89 34 24             	mov    %esi,(%esp)
c010ab25:	e8 ed 03 00 00       	call   c010af17 <strnlen>
c010ab2a:	29 c3                	sub    %eax,%ebx
c010ab2c:	89 d8                	mov    %ebx,%eax
c010ab2e:	89 45 e8             	mov    %eax,-0x18(%ebp)
c010ab31:	eb 17                	jmp    c010ab4a <vprintfmt+0x1eb>
                    putch(padc, putdat);
c010ab33:	0f be 45 db          	movsbl -0x25(%ebp),%eax
c010ab37:	8b 55 0c             	mov    0xc(%ebp),%edx
c010ab3a:	89 54 24 04          	mov    %edx,0x4(%esp)
c010ab3e:	89 04 24             	mov    %eax,(%esp)
c010ab41:	8b 45 08             	mov    0x8(%ebp),%eax
c010ab44:	ff d0                	call   *%eax
        case 's':
            if ((p = va_arg(ap, char *)) == NULL) {
                p = "(null)";
            }
            if (width > 0 && padc != '-') {
                for (width -= strnlen(p, precision); width > 0; width --) {
c010ab46:	83 6d e8 01          	subl   $0x1,-0x18(%ebp)
c010ab4a:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
c010ab4e:	7f e3                	jg     c010ab33 <vprintfmt+0x1d4>
                    putch(padc, putdat);
                }
            }
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
c010ab50:	eb 38                	jmp    c010ab8a <vprintfmt+0x22b>
                if (altflag && (ch < ' ' || ch > '~')) {
c010ab52:	83 7d dc 00          	cmpl   $0x0,-0x24(%ebp)
c010ab56:	74 1f                	je     c010ab77 <vprintfmt+0x218>
c010ab58:	83 fb 1f             	cmp    $0x1f,%ebx
c010ab5b:	7e 05                	jle    c010ab62 <vprintfmt+0x203>
c010ab5d:	83 fb 7e             	cmp    $0x7e,%ebx
c010ab60:	7e 15                	jle    c010ab77 <vprintfmt+0x218>
                    putch('?', putdat);
c010ab62:	8b 45 0c             	mov    0xc(%ebp),%eax
c010ab65:	89 44 24 04          	mov    %eax,0x4(%esp)
c010ab69:	c7 04 24 3f 00 00 00 	movl   $0x3f,(%esp)
c010ab70:	8b 45 08             	mov    0x8(%ebp),%eax
c010ab73:	ff d0                	call   *%eax
c010ab75:	eb 0f                	jmp    c010ab86 <vprintfmt+0x227>
                }
                else {
                    putch(ch, putdat);
c010ab77:	8b 45 0c             	mov    0xc(%ebp),%eax
c010ab7a:	89 44 24 04          	mov    %eax,0x4(%esp)
c010ab7e:	89 1c 24             	mov    %ebx,(%esp)
c010ab81:	8b 45 08             	mov    0x8(%ebp),%eax
c010ab84:	ff d0                	call   *%eax
            if (width > 0 && padc != '-') {
                for (width -= strnlen(p, precision); width > 0; width --) {
                    putch(padc, putdat);
                }
            ...
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
c010ab86:	83 6d e8 01          	subl   $0x1,-0x18(%ebp)
c010ab8a:	89 f0                	mov    %esi,%eax
c010ab8c:	8d 70 01             	lea    0x1(%eax),%esi
c010ab8f:	0f b6 00             	movzbl (%eax),%eax
c010ab92:	0f be d8             	movsbl %al,%ebx
c010ab95:	85 db                	test   %ebx,%ebx
c010ab97:	74 10                	je     c010aba9 <vprintfmt+0x24a>
c010ab99:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
c010ab9d:	78 b3                	js     c010ab52 <vprintfmt+0x1f3>
c010ab9f:	83 6d e4 01          	subl   $0x1,-0x1c(%ebp)
c010aba3:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
c010aba7:	79 a9                	jns    c010ab52 <vprintfmt+0x1f3>
                }
                else {
                    putch(ch, putdat);
                }
            ...
            for (; width > 0; width --) {
c010aba9:	eb 17                	jmp    c010abc2 <vprintfmt+0x263>
                putch(' ', putdat);
c010abab:	8b 45 0c             	mov    0xc(%ebp),%eax
c010abae:	89 44 24 04          	mov    %eax,0x4(%esp)
c010abb2:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
...
c010abbc:	ff d0                	call   *%eax
            ...
            for (; width > 0; width --) {
c010abbe:	83 6d e8 01          	subl   $0x1,-0x18(%ebp)
c010abc2:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
c010abc6:	7f e3                	jg     c010abab <vprintfmt+0x24c>
                putch(' ', putdat);
            }
            break;
c010abc8:	e9 70 01 00 00       	jmp    c010ad3d <vprintfmt+0x3de>

        // (signed) decimal
        case 'd':
            num = getint(&ap, lflag);
c010abcd:	8b 45 e0             	mov    -0x20(%ebp),%eax
c010abd0:	89 44 24 04          	mov    %eax,0x4(%esp)
c010abd4:	8d 45 14             	lea    0x14(%ebp),%eax
c010abd7:	89 04 24             	mov    %eax,(%esp)
c010abda:	e8 0b fd ff ff       	call   c010a8ea <getint>
c010abdf:	89 45 f0             	mov    %eax,-0x10(%ebp)
c010abe2:	89 55 f4             	mov    %edx,-0xc(%ebp)
            if ((long long)num < 0) {
c010abe5:	8b 45 f0             	mov    -0x10(%ebp),%eax
c010abe8:	8b 55 f4             	mov    -0xc(%ebp),%edx
c010abeb:	85 d2                	test   %edx,%edx
c010abed:	79 26                	jns    c010ac15 <vprintfmt+0x2b6>
                putch('-', putdat);
c010abef:	8b 45 0c             	mov    0xc(%ebp),%eax
c010abf2:	89 44 24 04          	mov    %eax,0x4(%esp)
c010abf6:	c7 04 24 2d 00 00 00 	movl   $0x2d,(%esp)
c010abfd:	8b 45 08             	mov    0x8(%ebp),%eax
c010ac00:	ff d0                	call   *%eax
                num = -(long long)num;
c010ac02:	8b 45 f0             	mov    -0x10(%ebp),%eax
c010ac05:	8b 55 f4             	mov    -0xc(%ebp),%edx
c010ac08:	f7 d8                	neg    %eax
c010ac0a:	83 d2 00             	adc    $0x0,%edx
c010ac0d:	f7 da                	neg    %edx
c010ac0f:	89 45 f0             	mov    %eax,-0x10(%ebp)
c010ac12:	89 55 f4             	mov    %edx,-0xc(%ebp)
            }
            base = 10;
c010ac15:	c7 45 ec 0a 00 00 00 	movl   $0xa,-0x14(%ebp)
            goto number;
c010ac1c:	e9 a8 00 00 00       	jmp    c010acc9 <vprintfmt+0x36a>

        // unsigned decimal
        case 'u':
            num = getuint(&ap, lflag);
c010ac21:	8b 45 e0             	mov    -0x20(%ebp),%eax
c010ac24:	89 44 24 04          	mov    %eax,0x4(%esp)
c010ac28:	8d 45 14             	lea    0x14(%ebp),%eax
c010ac2b:	89 04 24             	mov    %eax,(%esp)
c010ac2e:	e8 68 fc ff ff       	call   c010a89b <getuint>
c010ac33:	89 45 f0             	mov    %eax,-0x10(%ebp)
c010ac36:	89 55 f4             	mov    %edx,-0xc(%ebp)
            base = 10;
c010ac39:	c7 45 ec 0a 00 00 00 	movl   $0xa,-0x14(%ebp)
            goto number;
c010ac40:	e9 84 00 00 00       	jmp    c010acc9 <vprintfmt+0x36a>

        // (unsigned) octal
        case 'o':
            num = getuint(&ap, lflag);
c010ac45:	8b 45 e0             	mov    -0x20(%ebp),%eax
c010ac48:	89 44 24 04          	mov    %eax,0x4(%esp)
c010ac4c:	8d 45 14             	lea    0x14(%ebp),%eax
c010ac4f:	89 04 24             	mov    %eax,(%esp)
c010ac52:	e8 44 fc ff ff       	call   c010a89b <getuint>
c010ac57:	89 45 f0             	mov    %eax,-0x10(%ebp)
c010ac5a:	89 55 f4             	mov    %edx,-0xc(%ebp)
            base = 8;
c010ac5d:	c7 45 ec 08 00 00 00 	movl   $0x8,-0x14(%ebp)
            goto number;
c010ac64:	eb 63                	jmp    c010acc9 <vprintfmt+0x36a>

        // pointer
        case 'p':
            putch('0', putdat);
c010ac66:	8b 45 0c             	mov    0xc(%ebp),%eax
c010ac69:	89 44 24 04          	mov    %eax,0x4(%esp)
c010ac6d:	c7 04 24 30 00 00 00 	movl   $0x30,(%esp)
c010ac74:	8b 45 08             	mov    0x8(%ebp),%eax
c010ac77:	ff d0                	call   *%eax
            putch('x', putdat);
c010ac79:	8b 45 0c             	mov    0xc(%ebp),%eax
c010ac7c:	89 44 24 04          	mov    %eax,0x4(%esp)
c010ac80:	c7 04 24 78 00 00 00 	movl   $0x78,(%esp)
c010ac87:	8b 45 08             	mov    0x8(%ebp),%eax
c010ac8a:	ff d0                	call   *%eax
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
c010ac8c:	8b 45 14             	mov    0x14(%ebp),%eax
c010ac8f:	8d 50 04             	lea    0x4(%eax),%edx
c010ac92:	89 55 14             	mov    %edx,0x14(%ebp)
c010ac95:	8b 00                	mov    (%eax),%eax
c010ac97:	89 45 f0             	mov    %eax,-0x10(%ebp)
c010ac9a:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
            base = 16;
c010aca1:	c7 45 ec 10 00 00 00 	movl   $0x10,-0x14(%ebp)
            goto number;
c010aca8:	eb 1f                	jmp    c010acc9 <vprintfmt+0x36a>

        // (unsigned) hexadecimal
        case 'x':
            num = getuint(&ap, lflag);
c010acaa:	8b 45 e0             	mov    -0x20(%ebp),%eax
c010acad:	89 44 24 04          	mov    %eax,0x4(%esp)
c010acb1:	8d 45 14             	lea    0x14(%ebp),%eax
c010acb4:	89 04 24             	mov    %eax,(%esp)
c010acb7:	e8 df fb ff ff       	call   c010a89b <getuint>
c010acbc:	89 45 f0             	mov    %eax,-0x10(%ebp)
c010acbf:	89 55 f4             	mov    %edx,-0xc(%ebp)
            base = 16;
c010acc2:	c7 45 ec 10 00 00 00 	movl   $0x10,-0x14(%ebp)
        number:
            printnum(putch, putdat, num, base, width, padc);
c010acc9:	0f be 55 db          	movsbl -0x25(%ebp),%edx
c010accd:	8b 45 ec             	mov    -0x14(%ebp),%eax
c010acd0:	89 54 24 18          	mov    %edx,0x18(%esp)
c010acd4:	8b 55 e8             	mov    -0x18(%ebp),%edx
c010acd7:	89 54 24 14          	mov    %edx,0x14(%esp)
c010acdb:	89 44 24 10          	mov    %eax,0x10(%esp)
c010acdf:	8b 45 f0             	mov    -0x10(%ebp),%eax
c010ace2:	8b 55 f4             	mov    -0xc(%ebp),%edx
c010ace5:	89 44 24 08          	mov    %eax,0x8(%esp)
c010ace9:	89 54 24 0c          	mov    %edx,0xc(%esp)
c010aced:	8b 45 0c             	mov    0xc(%ebp),%eax
c010acf0:	89 44 24 04          	mov    %eax,0x4(%esp)
c010acf4:	8b 45 08             	mov    0x8(%ebp),%eax
c010acf7:	89 04 24             	mov    %eax,(%esp)
c010acfa:	e8 97 fa ff ff       	call   c010a796 <printnum>
            break;
c010acff:	eb 3c                	jmp    c010ad3d <vprintfmt+0x3de>

        // escaped '%' character
        case '%':
            putch(ch, putdat);
c010ad01:	8b 45 0c             	mov    0xc(%ebp),%eax
c010ad04:	89 44 24 04          	mov    %eax,0x4(%esp)
c010ad08:	89 1c 24             	mov    %ebx,(%esp)
c010ad0b:	8b 45 08             	mov    0x8(%ebp),%eax
c010ad0e:	ff d0                	call   *%eax
            break;
c010ad10:	eb 2b                	jmp    c010ad3d <vprintfmt+0x3de>

        // unrecognized escape sequence - just print it literally
        default:
            putch('%', putdat);
c010ad12:	8b 45 0c             	mov    0xc(%ebp),%eax
c010ad15:	89 44 24 04          	mov    %eax,0x4(%esp)
c010ad19:	c7 04 24 25 00 00 00 	movl   $0x25,(%esp)
c010ad20:	8b 45 08             	mov    0x8(%ebp),%eax
c010ad23:	ff d0                	call   *%eax
            for (fmt --; fmt[-1] != '%'; fmt --)
c010ad25:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
c010ad29:	eb 04                	jmp    c010ad2f <vprintfmt+0x3d0>
c010ad2b:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
c010ad2f:	8b 45 10             	mov    0x10(%ebp),%eax
c010ad32:	83 e8 01             	sub    $0x1,%eax
c010ad35:	0f b6 00             	movzbl (%eax),%eax
c010ad38:	3c 25                	cmp    $0x25,%al
c010ad3a:	75 ef                	jne    c010ad2b <vprintfmt+0x3cc>
                /* do nothing */;
            break;
c010ad3c:	90                   	nop
        }
...
c010ad3d:	90                   	nop
    ...
    while (1) {
        while ((ch = *(unsigned char *)fmt ++) != '%') {
c010ad3e:	e9 3e fc ff ff       	jmp    c010a981 <vprintfmt+0x22>
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
c010ad43:	83 c4 40             	add    $0x40,%esp
c010ad46:	5b                   	pop    %ebx
c010ad47:	5e                   	pop    %esi
c010ad48:	5d                   	pop    %ebp
c010ad49:	c3                   	ret    

c010ad4a <sprintputch>:
...
c010ad4b:	89 e5                	mov    %esp,%ebp
    b->cnt ++;
c010ad4d:	8b 45 0c             	mov    0xc(%ebp),%eax
c010ad50:	8b 40 08             	mov    0x8(%eax),%eax
c010ad53:	8d 50 01             	lea    0x1(%eax),%edx
c010ad56:	8b 45 0c             	mov    0xc(%ebp),%eax
c010ad59:	89 50 08             	mov    %edx,0x8(%eax)
    if (b->buf < b->ebuf) {
c010ad5c:	8b 45 0c             	mov    0xc(%ebp),%eax
c010ad5f:	8b 10                	mov    (%eax),%edx
c010ad61:	8b 45 0c             	mov    0xc(%ebp),%eax
c010ad64:	8b 40 04             	mov    0x4(%eax),%eax
c010ad67:	39 c2                	cmp    %eax,%edx
c010ad69:	73 12                	jae    c010ad7d <sprintputch+0x33>
        *b->buf ++ = ch;
c010ad6b:	8b 45 0c             	mov    0xc(%ebp),%eax
c010ad6e:	8b 00                	mov    (%eax),%eax
c010ad70:	8d 48 01             	lea    0x1(%eax),%ecx
c010ad73:	8b 55 0c             	mov    0xc(%ebp),%edx
c010ad76:	89 0a                	mov    %ecx,(%edx)
c010ad78:	8b 55 08             	mov    0x8(%ebp),%edx
c010ad7b:	88 10                	mov    %dl,(%eax)
    }
}
c010ad7d:	5d                   	pop    %ebp
c010ad7e:	c3                   	ret    
...
c010ad82:	83 ec 28             	sub    $0x28,%esp
    va_list ap;
    int cnt;
    va_start(ap, fmt);
c010ad85:	8d 45 14             	lea    0x14(%ebp),%eax
c010ad88:	89 45 f0             	mov    %eax,-0x10(%ebp)
    cnt = vsnprintf(str, size, fmt, ap);
c010ad8b:	8b 45 f0             	mov    -0x10(%ebp),%eax
c010ad8e:	89 44 24 0c          	mov    %eax,0xc(%esp)
c010ad92:	8b 45 10             	mov    0x10(%ebp),%eax
c010ad95:	89 44 24 08          	mov    %eax,0x8(%esp)
c010ad99:	8b 45 0c             	mov    0xc(%ebp),%eax
c010ad9c:	89 44 24 04          	mov    %eax,0x4(%esp)
c010ada0:	8b 45 08             	mov    0x8(%ebp),%eax
c010ada3:	89 04 24             	mov    %eax,(%esp)
c010ada6:	e8 08 00 00 00       	call   c010adb3 <vsnprintf>
c010adab:	89 45 f4             	mov    %eax,-0xc(%ebp)
    va_end(ap);
    return cnt;
c010adae:	8b 45 f4             	mov    -0xc(%ebp),%eax
}
c010adb1:	c9                   	leave  
c010adb2:	c3                   	ret    
...
c010adb6:	83 ec 28             	sub    $0x28,%esp
    struct sprintbuf b = {str, str + size - 1, 0};
c010adb9:	8b 45 08             	mov    0x8(%ebp),%eax
c010adbc:	89 45 ec             	mov    %eax,-0x14(%ebp)
c010adbf:	8b 45 0c             	mov    0xc(%ebp),%eax
c010adc2:	8d 50 ff             	lea    -0x1(%eax),%edx
c010adc5:	8b 45 08             	mov    0x8(%ebp),%eax
c010adc8:	01 d0                	add    %edx,%eax
c010adca:	89 45 f0             	mov    %eax,-0x10(%ebp)
c010adcd:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if (str == NULL || b.buf > b.ebuf) {
c010add4:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
c010add8:	74 0a                	je     c010ade4 <vsnprintf+0x31>
c010adda:	8b 55 ec             	mov    -0x14(%ebp),%edx
c010addd:	8b 45 f0             	mov    -0x10(%ebp),%eax
c010ade0:	39 c2                	cmp    %eax,%edx
c010ade2:	76 07                	jbe    c010adeb <vsnprintf+0x38>
        return -E_INVAL;
c010ade4:	b8 fd ff ff ff       	mov    $0xfffffffd,%eax
c010ade9:	eb 2a                	jmp    c010ae15 <vsnprintf+0x62>
    }
    // print the string to the buffer
    vprintfmt((void*)sprintputch, &b, fmt, ap);
c010adeb:	8b 45 14             	mov    0x14(%ebp),%eax
c010adee:	89 44 24 0c          	mov    %eax,0xc(%esp)
c010adf2:	8b 45 10             	mov    0x10(%ebp),%eax
c010adf5:	89 44 24 08          	mov    %eax,0x8(%esp)
c010adf9:	8d 45 ec             	lea    -0x14(%ebp),%eax
c010adfc:	89 44 24 04          	mov    %eax,0x4(%esp)
c010ae00:	c7 04 24 4a ad 10 c0 	movl   $0xc010ad4a,(%esp)
c010ae07:	e8 53 fb ff ff       	call   c010a95f <vprintfmt>
    // null terminate the buffer
    *b.buf = '\0';
c010ae0c:	8b 45 ec             	mov    -0x14(%ebp),%eax
c010ae0f:	c6 00 00             	movb   $0x0,(%eax)
    return b.cnt;
c010ae12:	8b 45 f4             	mov    -0xc(%ebp),%eax
}
c010ae15:	c9                   	leave  
c010ae16:	c3                   	ret    
...
c010ae1a:	57                   	push   %edi
c010ae1b:	56                   	push   %esi
c010ae1c:	53                   	push   %ebx
c010ae1d:	83 ec 24             	sub    $0x24,%esp
    next = (next * 0x5DEECE66DLL + 0xBLL) & ((1LL << 48) - 1);
c010ae20:	a1 88 8a 12 c0       	mov    0xc0128a88,%eax
c010ae25:	8b 15 8c 8a 12 c0    	mov    0xc0128a8c,%edx
c010ae2b:	69 fa 6d e6 ec de    	imul   $0xdeece66d,%edx,%edi
c010ae31:	6b f0 05             	imul   $0x5,%eax,%esi
c010ae34:	01 f7                	add    %esi,%edi
c010ae36:	be 6d e6 ec de       	mov    $0xdeece66d,%esi
c010ae3b:	f7 e6                	mul    %esi
c010ae3d:	8d 34 17             	lea    (%edi,%edx,1),%esi
c010ae40:	89 f2                	mov    %esi,%edx
c010ae42:	83 c0 0b             	add    $0xb,%eax
c010ae45:	83 d2 00             	adc    $0x0,%edx
c010ae48:	89 c7                	mov    %eax,%edi
c010ae4a:	83 e7 ff             	and    $0xffffffff,%edi
c010ae4d:	89 f9                	mov    %edi,%ecx
c010ae4f:	0f b7 da             	movzwl %dx,%ebx
c010ae52:	89 0d 88 8a 12 c0    	mov    %ecx,0xc0128a88
c010ae58:	89 1d 8c 8a 12 c0    	mov    %ebx,0xc0128a8c
    unsigned long long result = (next >> 12);
c010ae5e:	a1 88 8a 12 c0       	mov    0xc0128a88,%eax
c010ae63:	8b 15 8c 8a 12 c0    	mov    0xc0128a8c,%edx
c010ae69:	0f ac d0 0c          	shrd   $0xc,%edx,%eax
c010ae6d:	c1 ea 0c             	shr    $0xc,%edx
c010ae70:	89 45 e0             	mov    %eax,-0x20(%ebp)
c010ae73:	89 55 e4             	mov    %edx,-0x1c(%ebp)
    return (int)do_div(result, RAND_MAX + 1);
c010ae76:	c7 45 dc 00 00 00 80 	movl   $0x80000000,-0x24(%ebp)
c010ae7d:	8b 45 e0             	mov    -0x20(%ebp),%eax
c010ae80:	8b 55 e4             	mov    -0x1c(%ebp),%edx
c010ae83:	89 45 d8             	mov    %eax,-0x28(%ebp)
c010ae86:	89 55 e8             	mov    %edx,-0x18(%ebp)
c010ae89:	8b 45 e8             	mov    -0x18(%ebp),%eax
c010ae8c:	89 45 ec             	mov    %eax,-0x14(%ebp)
c010ae8f:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
c010ae93:	74 1c                	je     c010aeb1 <rand+0x9a>
c010ae95:	8b 45 e8             	mov    -0x18(%ebp),%eax
c010ae98:	ba 00 00 00 00       	mov    $0x0,%edx
c010ae9d:	f7 75 dc             	divl   -0x24(%ebp)
c010aea0:	89 55 ec             	mov    %edx,-0x14(%ebp)
c010aea3:	8b 45 e8             	mov    -0x18(%ebp),%eax
c010aea6:	ba 00 00 00 00       	mov    $0x0,%edx
c010aeab:	f7 75 dc             	divl   -0x24(%ebp)
c010aeae:	89 45 e8             	mov    %eax,-0x18(%ebp)
c010aeb1:	8b 45 d8             	mov    -0x28(%ebp),%eax
c010aeb4:	8b 55 ec             	mov    -0x14(%ebp),%edx
c010aeb7:	f7 75 dc             	divl   -0x24(%ebp)
c010aeba:	89 45 d8             	mov    %eax,-0x28(%ebp)
c010aebd:	89 55 d4             	mov    %edx,-0x2c(%ebp)
c010aec0:	8b 45 d8             	mov    -0x28(%ebp),%eax
c010aec3:	8b 55 e8             	mov    -0x18(%ebp),%edx
c010aec6:	89 45 e0             	mov    %eax,-0x20(%ebp)
c010aec9:	89 55 e4             	mov    %edx,-0x1c(%ebp)
c010aecc:	8b 45 d4             	mov    -0x2c(%ebp),%eax
}
c010aecf:	83 c4 24             	add    $0x24,%esp
c010aed2:	5b                   	pop    %ebx
c010aed3:	5e                   	pop    %esi
c010aed4:	5f                   	pop    %edi
c010aed5:	5d                   	pop    %ebp
...
c010aedd:	ba 00 00 00 00       	mov    $0x0,%edx
c010aee2:	a3 88 8a 12 c0       	mov    %eax,0xc0128a88
c010aee7:	89 15 8c 8a 12 c0    	mov    %edx,0xc0128a8c
}
c010aeed:	5d                   	pop    %ebp
c010aeee:	c3                   	ret    
...
size_t
strlen(const char *s) {
c010aeef:	55                   	push   %ebp
c010aef0:	89 e5                	mov    %esp,%ebp
c010aef2:	83 ec 10             	sub    $0x10,%esp
    size_t cnt = 0;
c010aef5:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
    while (*s ++ != '\0') {
c010aefc:	eb 04                	jmp    c010af02 <strlen+0x13>
        cnt ++;
c010aefe:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
 * The strlen() function returns the length of string @s.
 * */
size_t
strlen(const char *s) {
    size_t cnt = 0;
    while (*s ++ != '\0') {
c010af02:	8b 45 08             	mov    0x8(%ebp),%eax
c010af05:	8d 50 01             	lea    0x1(%eax),%edx
c010af08:	89 55 08             	mov    %edx,0x8(%ebp)
c010af0b:	0f b6 00             	movzbl (%eax),%eax
c010af0e:	84 c0                	test   %al,%al
c010af10:	75 ec                	jne    c010aefe <strlen+0xf>
        cnt ++;
    }
    return cnt;
c010af12:	8b 45 fc             	mov    -0x4(%ebp),%eax
}
c010af15:	c9                   	leave  
c010af16:	c3                   	ret    
...
c010af17:	55                   	push   %ebp
c010af18:	89 e5                	mov    %esp,%ebp
c010af1a:	83 ec 10             	sub    $0x10,%esp
    size_t cnt = 0;
c010af1d:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
    while (cnt < len && *s ++ != '\0') {
c010af24:	eb 04                	jmp    c010af2a <strnlen+0x13>
        cnt ++;
c010af26:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
 * pointed by @s.
 * */
size_t
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
    while (cnt < len && *s ++ != '\0') {
c010af2a:	8b 45 fc             	mov    -0x4(%ebp),%eax
c010af2d:	3b 45 0c             	cmp    0xc(%ebp),%eax
c010af30:	73 10                	jae    c010af42 <strnlen+0x2b>
c010af32:	8b 45 08             	mov    0x8(%ebp),%eax
c010af35:	8d 50 01             	lea    0x1(%eax),%edx
c010af38:	89 55 08             	mov    %edx,0x8(%ebp)
c010af3b:	0f b6 00             	movzbl (%eax),%eax
c010af3e:	84 c0                	test   %al,%al
c010af40:	75 e4                	jne    c010af26 <strnlen+0xf>
        cnt ++;
    }
    return cnt;
c010af42:	8b 45 fc             	mov    -0x4(%ebp),%eax
}
c010af45:	c9                   	leave  
c010af46:	c3                   	ret    
...
c010af47:	55                   	push   %ebp
c010af48:	89 e5                	mov    %esp,%ebp
c010af4a:	57                   	push   %edi
c010af4b:	56                   	push   %esi
c010af4c:	83 ec 20             	sub    $0x20,%esp
c010af4f:	8b 45 08             	mov    0x8(%ebp),%eax
c010af52:	89 45 f4             	mov    %eax,-0xc(%ebp)
...
__strcpy(char *dst, const char *src) {
    int d0, d1, d2;
    asm volatile (
c010af5b:	8b 55 f0             	mov    -0x10(%ebp),%edx
c010af5e:	8b 45 f4             	mov    -0xc(%ebp),%eax
c010af61:	89 d1                	mov    %edx,%ecx
c010af63:	89 c2                	mov    %eax,%edx
c010af65:	89 ce                	mov    %ecx,%esi
c010af67:	89 d7                	mov    %edx,%edi
c010af69:	ac                   	lods   %ds:(%esi),%al
c010af6a:	aa                   	stos   %al,%es:(%edi)
c010af6b:	84 c0                	test   %al,%al
c010af6d:	75 fa                	jne    c010af69 <strcpy+0x22>
c010af6f:	89 fa                	mov    %edi,%edx
c010af71:	89 f1                	mov    %esi,%ecx
c010af73:	89 4d ec             	mov    %ecx,-0x14(%ebp)
c010af76:	89 55 e8             	mov    %edx,-0x18(%ebp)
c010af79:	89 45 e4             	mov    %eax,-0x1c(%ebp)
        ...
        : "0" (src), "1" (dst) : "memory");
    return dst;
c010af7c:	8b 45 f4             	mov    -0xc(%ebp),%eax
    char *p = dst;
    while ((*p ++ = *src ++) != '\0')
        /* nothing */;
    return dst;
...
c010af7f:	83 c4 20             	add    $0x20,%esp
c010af82:	5e                   	pop    %esi
c010af83:	5f                   	pop    %edi
c010af84:	5d                   	pop    %ebp
c010af85:	c3                   	ret    
...
c010af86:	55                   	push   %ebp
c010af87:	89 e5                	mov    %esp,%ebp
c010af89:	83 ec 10             	sub    $0x10,%esp
    char *p = dst;
c010af8c:	8b 45 08             	mov    0x8(%ebp),%eax
c010af8f:	89 45 fc             	mov    %eax,-0x4(%ebp)
    while (len > 0) {
c010af92:	eb 21                	jmp    c010afb5 <strncpy+0x2f>
        if ((*p = *src) != '\0') {
c010af94:	8b 45 0c             	mov    0xc(%ebp),%eax
c010af97:	0f b6 10             	movzbl (%eax),%edx
c010af9a:	8b 45 fc             	mov    -0x4(%ebp),%eax
c010af9d:	88 10                	mov    %dl,(%eax)
c010af9f:	8b 45 fc             	mov    -0x4(%ebp),%eax
c010afa2:	0f b6 00             	movzbl (%eax),%eax
c010afa5:	84 c0                	test   %al,%al
c010afa7:	74 04                	je     c010afad <strncpy+0x27>
            src ++;
c010afa9:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
        }
        p ++, len --;
c010afad:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
c010afb1:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
 * The return value is @dst
 * */
char *
strncpy(char *dst, const char *src, size_t len) {
    char *p = dst;
    while (len > 0) {
c010afb5:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
c010afb9:	75 d9                	jne    c010af94 <strncpy+0xe>
        if ((*p = *src) != '\0') {
            src ++;
        }
        p ++, len --;
    ...
    return dst;
c010afbb:	8b 45 08             	mov    0x8(%ebp),%eax
}
c010afbe:	c9                   	leave  
c010afbf:	c3                   	ret    
...
c010afc3:	57                   	push   %edi
c010afc4:	56                   	push   %esi
c010afc5:	83 ec 20             	sub    $0x20,%esp
c010afc8:	8b 45 08             	mov    0x8(%ebp),%eax
c010afcb:	89 45 f4             	mov    %eax,-0xc(%ebp)
c010afce:	8b 45 0c             	mov    0xc(%ebp),%eax
c010afd1:	89 45 f0             	mov    %eax,-0x10(%ebp)
...
__strcmp(const char *s1, const char *s2) {
    int d0, d1, ret;
    asm volatile (
c010afd4:	8b 55 f4             	mov    -0xc(%ebp),%edx
c010afd7:	8b 45 f0             	mov    -0x10(%ebp),%eax
c010afda:	89 d1                	mov    %edx,%ecx
c010afdc:	89 c2                	mov    %eax,%edx
c010afde:	89 ce                	mov    %ecx,%esi
c010afe0:	89 d7                	mov    %edx,%edi
c010afe2:	ac                   	lods   %ds:(%esi),%al
c010afe3:	ae                   	scas   %es:(%edi),%al
c010afe4:	75 08                	jne    c010afee <strcmp+0x2e>
c010afe6:	84 c0                	test   %al,%al
c010afe8:	75 f8                	jne    c010afe2 <strcmp+0x22>
c010afea:	31 c0                	xor    %eax,%eax
c010afec:	eb 04                	jmp    c010aff2 <strcmp+0x32>
c010afee:	19 c0                	sbb    %eax,%eax
c010aff0:	0c 01                	or     $0x1,%al
c010aff2:	89 fa                	mov    %edi,%edx
c010aff4:	89 f1                	mov    %esi,%ecx
c010aff6:	89 45 ec             	mov    %eax,-0x14(%ebp)
c010aff9:	89 4d e8             	mov    %ecx,-0x18(%ebp)
c010affc:	89 55 e4             	mov    %edx,-0x1c(%ebp)
        "orb $1, %%al;"
        "3:"
        : "=a" (ret), "=&S" (d0), "=&D" (d1)
        : "1" (s1), "2" (s2)
        : "memory");
    return ret;
c010afff:	8b 45 ec             	mov    -0x14(%ebp),%eax
    while (*s1 != '\0' && *s1 == *s2) {
        s1 ++, s2 ++;
    }
...
c010b002:	83 c4 20             	add    $0x20,%esp
c010b005:	5e                   	pop    %esi
c010b006:	5f                   	pop    %edi
c010b007:	5d                   	pop    %ebp
c010b008:	c3                   	ret    
...
c010b00c:	eb 0c                	jmp    c010b01a <strncmp+0x11>
        n --, s1 ++, s2 ++;
c010b00e:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
c010b012:	83 45 08 01          	addl   $0x1,0x8(%ebp)
c010b016:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
 * the characters differ, until a terminating null-character is reached, or
 * until @n characters match in both strings, whichever happens first.
 * */
int
strncmp(const char *s1, const char *s2, size_t n) {
    while (n > 0 && *s1 != '\0' && *s1 == *s2) {
c010b01a:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
c010b01e:	74 1a                	je     c010b03a <strncmp+0x31>
c010b020:	8b 45 08             	mov    0x8(%ebp),%eax
c010b023:	0f b6 00             	movzbl (%eax),%eax
c010b026:	84 c0                	test   %al,%al
c010b028:	74 10                	je     c010b03a <strncmp+0x31>
c010b02a:	8b 45 08             	mov    0x8(%ebp),%eax
c010b02d:	0f b6 10             	movzbl (%eax),%edx
c010b030:	8b 45 0c             	mov    0xc(%ebp),%eax
c010b033:	0f b6 00             	movzbl (%eax),%eax
c010b036:	38 c2                	cmp    %al,%dl
c010b038:	74 d4                	je     c010b00e <strncmp+0x5>
        n --, s1 ++, s2 ++;
    }
    return (n == 0) ? 0 : (int)((unsigned char)*s1 - (unsigned char)*s2);
c010b03a:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
c010b03e:	74 18                	je     c010b058 <strncmp+0x4f>
c010b040:	8b 45 08             	mov    0x8(%ebp),%eax
c010b043:	0f b6 00             	movzbl (%eax),%eax
c010b046:	0f b6 d0             	movzbl %al,%edx
c010b049:	8b 45 0c             	mov    0xc(%ebp),%eax
c010b04c:	0f b6 00             	movzbl (%eax),%eax
c010b04f:	0f b6 c0             	movzbl %al,%eax
c010b052:	29 c2                	sub    %eax,%edx
c010b054:	89 d0                	mov    %edx,%eax
c010b056:	eb 05                	jmp    c010b05d <strncmp+0x54>
c010b058:	b8 00 00 00 00       	mov    $0x0,%eax
}
c010b05d:	5d                   	pop    %ebp
c010b05e:	c3                   	ret    
...
c010b05f:	55                   	push   %ebp
c010b060:	89 e5                	mov    %esp,%ebp
c010b062:	83 ec 04             	sub    $0x4,%esp
c010b065:	8b 45 0c             	mov    0xc(%ebp),%eax
c010b068:	88 45 fc             	mov    %al,-0x4(%ebp)
    while (*s != '\0') {
c010b06b:	eb 14                	jmp    c010b081 <strchr+0x22>
        if (*s == c) {
c010b06d:	8b 45 08             	mov    0x8(%ebp),%eax
c010b070:	0f b6 00             	movzbl (%eax),%eax
c010b073:	3a 45 fc             	cmp    -0x4(%ebp),%al
c010b076:	75 05                	jne    c010b07d <strchr+0x1e>
            return (char *)s;
c010b078:	8b 45 08             	mov    0x8(%ebp),%eax
c010b07b:	eb 13                	jmp    c010b090 <strchr+0x31>
        }
        s ++;
c010b07d:	83 45 08 01          	addl   $0x1,0x8(%ebp)
 * The strchr() function returns a pointer to the first occurrence of
 * character in @s. If the value is not found, the function returns 'NULL'.
 * */
char *
...
c010b084:	0f b6 00             	movzbl (%eax),%eax
c010b087:	84 c0                	test   %al,%al
c010b089:	75 e2                	jne    c010b06d <strchr+0xe>
        if (*s == c) {
            return (char *)s;
        }
        s ++;
    ...
    return NULL;
c010b08b:	b8 00 00 00 00       	mov    $0x0,%eax
}
c010b090:	c9                   	leave  
c010b091:	c3                   	ret    
...
c010b095:	83 ec 04             	sub    $0x4,%esp
c010b098:	8b 45 0c             	mov    0xc(%ebp),%eax
c010b09b:	88 45 fc             	mov    %al,-0x4(%ebp)
    while (*s != '\0') {
c010b09e:	eb 11                	jmp    c010b0b1 <strfind+0x1f>
        if (*s == c) {
c010b0a0:	8b 45 08             	mov    0x8(%ebp),%eax
c010b0a3:	0f b6 00             	movzbl (%eax),%eax
c010b0a6:	3a 45 fc             	cmp    -0x4(%ebp),%al
c010b0a9:	75 02                	jne    c010b0ad <strfind+0x1b>
            break;
c010b0ab:	eb 0e                	jmp    c010b0bb <strfind+0x29>
        }
        s ++;
c010b0ad:	83 45 08 01          	addl   $0x1,0x8(%ebp)
 * not found in @s, then it returns a pointer to the null byte at the
 * end of @s, rather than 'NULL'.
 * */
char *
...
c010b0b4:	0f b6 00             	movzbl (%eax),%eax
c010b0b7:	84 c0                	test   %al,%al
c010b0b9:	75 e5                	jne    c010b0a0 <strfind+0xe>
        if (*s == c) {
            break;
        }
        s ++;
...
c010b0c3:	83 ec 10             	sub    $0x10,%esp
    int neg = 0;
c010b0c6:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
    long val = 0;
c010b0cd:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)

    // gobble initial whitespace
    while (*s == ' ' || *s == '\t') {
c010b0d4:	eb 04                	jmp    c010b0da <strtol+0x1a>
        s ++;
c010b0d6:	83 45 08 01          	addl   $0x1,0x8(%ebp)
strtol(const char *s, char **endptr, int base) {
    int neg = 0;
    long val = 0;
...
c010b0dd:	0f b6 00             	movzbl (%eax),%eax
c010b0e0:	3c 20                	cmp    $0x20,%al
c010b0e2:	74 f2                	je     c010b0d6 <strtol+0x16>
c010b0e4:	8b 45 08             	mov    0x8(%ebp),%eax
c010b0e7:	0f b6 00             	movzbl (%eax),%eax
c010b0ea:	3c 09                	cmp    $0x9,%al
c010b0ec:	74 e8                	je     c010b0d6 <strtol+0x16>
        s ++;
    }
...
c010b0f4:	3c 2b                	cmp    $0x2b,%al
c010b0f6:	75 06                	jne    c010b0fe <strtol+0x3e>
        s ++;
c010b0f8:	83 45 08 01          	addl   $0x1,0x8(%ebp)
c010b0fc:	eb 15                	jmp    c010b113 <strtol+0x53>
    }
    else if (*s == '-') {
c010b0fe:	8b 45 08             	mov    0x8(%ebp),%eax
c010b101:	0f b6 00             	movzbl (%eax),%eax
c010b104:	3c 2d                	cmp    $0x2d,%al
c010b106:	75 0b                	jne    c010b113 <strtol+0x53>
        s ++, neg = 1;
c010b108:	83 45 08 01          	addl   $0x1,0x8(%ebp)
c010b10c:	c7 45 fc 01 00 00 00 	movl   $0x1,-0x4(%ebp)
    }

    // hex or octal base prefix
    if ((base == 0 || base == 16) && (s[0] == '0' && s[1] == 'x')) {
c010b113:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
c010b117:	74 06                	je     c010b11f <strtol+0x5f>
c010b119:	83 7d 10 10          	cmpl   $0x10,0x10(%ebp)
c010b11d:	75 24                	jne    c010b143 <strtol+0x83>
c010b11f:	8b 45 08             	mov    0x8(%ebp),%eax
c010b122:	0f b6 00             	movzbl (%eax),%eax
c010b125:	3c 30                	cmp    $0x30,%al
c010b127:	75 1a                	jne    c010b143 <strtol+0x83>
c010b129:	8b 45 08             	mov    0x8(%ebp),%eax
c010b12c:	83 c0 01             	add    $0x1,%eax
c010b12f:	0f b6 00             	movzbl (%eax),%eax
c010b132:	3c 78                	cmp    $0x78,%al
c010b134:	75 0d                	jne    c010b143 <strtol+0x83>
        s += 2, base = 16;
c010b136:	83 45 08 02          	addl   $0x2,0x8(%ebp)
c010b13a:	c7 45 10 10 00 00 00 	movl   $0x10,0x10(%ebp)
c010b141:	eb 2a                	jmp    c010b16d <strtol+0xad>
    }
    else if (base == 0 && s[0] == '0') {
c010b143:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
c010b147:	75 17                	jne    c010b160 <strtol+0xa0>
c010b149:	8b 45 08             	mov    0x8(%ebp),%eax
c010b14c:	0f b6 00             	movzbl (%eax),%eax
c010b14f:	3c 30                	cmp    $0x30,%al
c010b151:	75 0d                	jne    c010b160 <strtol+0xa0>
        s ++, base = 8;
c010b153:	83 45 08 01          	addl   $0x1,0x8(%ebp)
c010b157:	c7 45 10 08 00 00 00 	movl   $0x8,0x10(%ebp)
c010b15e:	eb 0d                	jmp    c010b16d <strtol+0xad>
    }
    else if (base == 0) {
c010b160:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
c010b164:	75 07                	jne    c010b16d <strtol+0xad>
        base = 10;
c010b166:	c7 45 10 0a 00 00 00 	movl   $0xa,0x10(%ebp)
    ...
    while (1) {
        ...
        if (*s >= '0' && *s <= '9') {
c010b16d:	8b 45 08             	mov    0x8(%ebp),%eax
c010b170:	0f b6 00             	movzbl (%eax),%eax
c010b173:	3c 2f                	cmp    $0x2f,%al
c010b175:	7e 1b                	jle    c010b192 <strtol+0xd2>
c010b177:	8b 45 08             	mov    0x8(%ebp),%eax
c010b17a:	0f b6 00             	movzbl (%eax),%eax
c010b17d:	3c 39                	cmp    $0x39,%al
c010b17f:	7f 11                	jg     c010b192 <strtol+0xd2>
            dig = *s - '0';
c010b181:	8b 45 08             	mov    0x8(%ebp),%eax
c010b184:	0f b6 00             	movzbl (%eax),%eax
c010b187:	0f be c0             	movsbl %al,%eax
c010b18a:	83 e8 30             	sub    $0x30,%eax
c010b18d:	89 45 f4             	mov    %eax,-0xc(%ebp)
c010b190:	eb 48                	jmp    c010b1da <strtol+0x11a>
        }
        else if (*s >= 'a' && *s <= 'z') {
c010b192:	8b 45 08             	mov    0x8(%ebp),%eax
c010b195:	0f b6 00             	movzbl (%eax),%eax
c010b198:	3c 60                	cmp    $0x60,%al
c010b19a:	7e 1b                	jle    c010b1b7 <strtol+0xf7>
c010b19c:	8b 45 08             	mov    0x8(%ebp),%eax
c010b19f:	0f b6 00             	movzbl (%eax),%eax
c010b1a2:	3c 7a                	cmp    $0x7a,%al
c010b1a4:	7f 11                	jg     c010b1b7 <strtol+0xf7>
            dig = *s - 'a' + 10;
c010b1a6:	8b 45 08             	mov    0x8(%ebp),%eax
c010b1a9:	0f b6 00             	movzbl (%eax),%eax
c010b1ac:	0f be c0             	movsbl %al,%eax
c010b1af:	83 e8 57             	sub    $0x57,%eax
c010b1b2:	89 45 f4             	mov    %eax,-0xc(%ebp)
c010b1b5:	eb 23                	jmp    c010b1da <strtol+0x11a>
        }
        else if (*s >= 'A' && *s <= 'Z') {
c010b1b7:	8b 45 08             	mov    0x8(%ebp),%eax
c010b1ba:	0f b6 00             	movzbl (%eax),%eax
c010b1bd:	3c 40                	cmp    $0x40,%al
c010b1bf:	7e 3d                	jle    c010b1fe <strtol+0x13e>
c010b1c1:	8b 45 08             	mov    0x8(%ebp),%eax
c010b1c4:	0f b6 00             	movzbl (%eax),%eax
c010b1c7:	3c 5a                	cmp    $0x5a,%al
c010b1c9:	7f 33                	jg     c010b1fe <strtol+0x13e>
            dig = *s - 'A' + 10;
c010b1cb:	8b 45 08             	mov    0x8(%ebp),%eax
c010b1ce:	0f b6 00             	movzbl (%eax),%eax
c010b1d1:	0f be c0             	movsbl %al,%eax
c010b1d4:	83 e8 37             	sub    $0x37,%eax
c010b1d7:	89 45 f4             	mov    %eax,-0xc(%ebp)
        }
        else {
            break;
        }
        if (dig >= base) {
c010b1da:	8b 45 f4             	mov    -0xc(%ebp),%eax
c010b1dd:	3b 45 10             	cmp    0x10(%ebp),%eax
c010b1e0:	7c 02                	jl     c010b1e4 <strtol+0x124>
            break;
c010b1e2:	eb 1a                	jmp    c010b1fe <strtol+0x13e>
        }
        s ++, val = (val * base) + dig;
c010b1e4:	83 45 08 01          	addl   $0x1,0x8(%ebp)
c010b1e8:	8b 45 f8             	mov    -0x8(%ebp),%eax
c010b1eb:	0f af 45 10          	imul   0x10(%ebp),%eax
c010b1ef:	89 c2                	mov    %eax,%edx
c010b1f1:	8b 45 f4             	mov    -0xc(%ebp),%eax
c010b1f4:	01 d0                	add    %edx,%eax
c010b1f6:	89 45 f8             	mov    %eax,-0x8(%ebp)
        // we don't properly detect overflow!
    }
c010b1f9:	e9 6f ff ff ff       	jmp    c010b16d <strtol+0xad>

    if (endptr) {
c010b1fe:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
c010b202:	74 08                	je     c010b20c <strtol+0x14c>
        *endptr = (char *) s;
c010b204:	8b 45 0c             	mov    0xc(%ebp),%eax
c010b207:	8b 55 08             	mov    0x8(%ebp),%edx
c010b20a:	89 10                	mov    %edx,(%eax)
    }
    return (neg ? -val : val);
c010b20c:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
c010b210:	74 07                	je     c010b219 <strtol+0x159>
c010b212:	8b 45 f8             	mov    -0x8(%ebp),%eax
c010b215:	f7 d8                	neg    %eax
c010b217:	eb 03                	jmp    c010b21c <strtol+0x15c>
c010b219:	8b 45 f8             	mov    -0x8(%ebp),%eax
}
c010b21c:	c9                   	leave  
c010b21d:	c3                   	ret    
...
c010b221:	57                   	push   %edi
c010b222:	83 ec 24             	sub    $0x24,%esp
c010b225:	8b 45 0c             	mov    0xc(%ebp),%eax
c010b228:	88 45 d8             	mov    %al,-0x28(%ebp)
#ifdef __HAVE_ARCH_MEMSET
    return __memset(s, c, n);
c010b22b:	0f be 45 d8          	movsbl -0x28(%ebp),%eax
c010b22f:	8b 55 08             	mov    0x8(%ebp),%edx
c010b232:	89 55 f8             	mov    %edx,-0x8(%ebp)
c010b235:	88 45 f7             	mov    %al,-0x9(%ebp)
c010b238:	8b 45 10             	mov    0x10(%ebp),%eax
c010b23b:	89 45 f0             	mov    %eax,-0x10(%ebp)
...
__memset(void *s, char c, size_t n) {
    int d0, d1;
    asm volatile (
c010b23e:	8b 4d f0             	mov    -0x10(%ebp),%ecx
c010b241:	0f b6 45 f7          	movzbl -0x9(%ebp),%eax
c010b245:	8b 55 f8             	mov    -0x8(%ebp),%edx
c010b248:	89 d7                	mov    %edx,%edi
c010b24a:	f3 aa                	rep stos %al,%es:(%edi)
c010b24c:	89 fa                	mov    %edi,%edx
c010b24e:	89 4d ec             	mov    %ecx,-0x14(%ebp)
c010b251:	89 55 e8             	mov    %edx,-0x18(%ebp)
        "rep; stosb;"
        : "=&c" (d0), "=&D" (d1)
        : "0" (n), "a" (c), "1" (s)
        : "memory");
...
c010b257:	83 c4 24             	add    $0x24,%esp
c010b25a:	5f                   	pop    %edi
c010b25b:	5d                   	pop    %ebp
c010b25c:	c3                   	ret    
...
c010b260:	57                   	push   %edi
c010b261:	56                   	push   %esi
c010b262:	53                   	push   %ebx
c010b263:	83 ec 30             	sub    $0x30,%esp
c010b266:	8b 45 08             	mov    0x8(%ebp),%eax
c010b269:	89 45 f0             	mov    %eax,-0x10(%ebp)
c010b26c:	8b 45 0c             	mov    0xc(%ebp),%eax
c010b26f:	89 45 ec             	mov    %eax,-0x14(%ebp)
c010b272:	8b 45 10             	mov    0x10(%ebp),%eax
c010b275:	89 45 e8             	mov    %eax,-0x18(%ebp)
...
c010b27b:	3b 45 ec             	cmp    -0x14(%ebp),%eax
c010b27e:	73 42                	jae    c010b2c2 <memmove+0x65>
c010b280:	8b 45 f0             	mov    -0x10(%ebp),%eax
c010b283:	89 45 e4             	mov    %eax,-0x1c(%ebp)
c010b286:	8b 45 ec             	mov    -0x14(%ebp),%eax
c010b289:	89 45 e0             	mov    %eax,-0x20(%ebp)
c010b28c:	8b 45 e8             	mov    -0x18(%ebp),%eax
c010b28f:	89 45 dc             	mov    %eax,-0x24(%ebp)
        "andl $3, %%ecx;"
        "jz 1f;"
        "rep; movsb;"
        "1:"
...
c010b292:	8b 45 dc             	mov    -0x24(%ebp),%eax
c010b295:	c1 e8 02             	shr    $0x2,%eax
...
__memcpy(void *dst, const void *src, size_t n) {
    int d0, d1, d2;
    asm volatile (
c010b29a:	8b 55 e4             	mov    -0x1c(%ebp),%edx
c010b29d:	8b 45 e0             	mov    -0x20(%ebp),%eax
c010b2a0:	89 d7                	mov    %edx,%edi
c010b2a2:	89 c6                	mov    %eax,%esi
c010b2a4:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
c010b2a6:	8b 4d dc             	mov    -0x24(%ebp),%ecx
c010b2a9:	83 e1 03             	and    $0x3,%ecx
c010b2ac:	74 02                	je     c010b2b0 <memmove+0x53>
c010b2ae:	f3 a4                	rep movsb %ds:(%esi),%es:(%edi)
c010b2b0:	89 f0                	mov    %esi,%eax
c010b2b2:	89 fa                	mov    %edi,%edx
c010b2b4:	89 4d d8             	mov    %ecx,-0x28(%ebp)
c010b2b7:	89 55 d4             	mov    %edx,-0x2c(%ebp)
c010b2ba:	89 45 d0             	mov    %eax,-0x30(%ebp)
        "rep; movsb;"
        "1:"
        : "=&c" (d0), "=&D" (d1), "=&S" (d2)
        : "0" (n / 4), "g" (n), "1" (dst), "2" (src)
        : "memory");
    return dst;
c010b2bd:	8b 45 e4             	mov    -0x1c(%ebp),%eax
c010b2c0:	eb 36                	jmp    c010b2f8 <memmove+0x9b>
    asm volatile (
        "std;"
        "rep; movsb;"
        "cld;"
...
c010b2c2:	8b 45 e8             	mov    -0x18(%ebp),%eax
c010b2c5:	8d 50 ff             	lea    -0x1(%eax),%edx
c010b2c8:	8b 45 ec             	mov    -0x14(%ebp),%eax
c010b2cb:	01 c2                	add    %eax,%edx
c010b2cd:	8b 45 e8             	mov    -0x18(%ebp),%eax
c010b2d0:	8d 48 ff             	lea    -0x1(%eax),%ecx
c010b2d3:	8b 45 f0             	mov    -0x10(%ebp),%eax
c010b2d6:	8d 1c 01             	lea    (%ecx,%eax,1),%ebx
__memmove(void *dst, const void *src, size_t n) {
    if (dst < src) {
    ...
    int d0, d1, d2;
    asm volatile (
c010b2d9:	8b 45 e8             	mov    -0x18(%ebp),%eax
c010b2dc:	89 c1                	mov    %eax,%ecx
c010b2de:	89 d8                	mov    %ebx,%eax
c010b2e0:	89 d6                	mov    %edx,%esi
c010b2e2:	89 c7                	mov    %eax,%edi
c010b2e4:	fd                   	std    
c010b2e5:	f3 a4                	rep movsb %ds:(%esi),%es:(%edi)
c010b2e7:	fc                   	cld    
c010b2e8:	89 f8                	mov    %edi,%eax
c010b2ea:	89 f2                	mov    %esi,%edx
c010b2ec:	89 4d cc             	mov    %ecx,-0x34(%ebp)
c010b2ef:	89 55 c8             	mov    %edx,-0x38(%ebp)
c010b2f2:	89 45 c4             	mov    %eax,-0x3c(%ebp)
        "rep; movsb;"
        "cld;"
        : "=&c" (d0), "=&S" (d1), "=&D" (d2)
        : "0" (n), "1" (n - 1 + src), "2" (n - 1 + dst)
        : "memory");
    return dst;
c010b2f5:	8b 45 f0             	mov    -0x10(%ebp),%eax
            *d ++ = *s ++;
        }
    }
    return dst;
...
c010b2f8:	83 c4 30             	add    $0x30,%esp
c010b2fb:	5b                   	pop    %ebx
c010b2fc:	5e                   	pop    %esi
c010b2fd:	5f                   	pop    %edi
c010b2fe:	5d                   	pop    %ebp
...
c010b300:	55                   	push   %ebp
c010b301:	89 e5                	mov    %esp,%ebp
c010b303:	57                   	push   %edi
c010b304:	56                   	push   %esi
c010b305:	83 ec 20             	sub    $0x20,%esp
c010b308:	8b 45 08             	mov    0x8(%ebp),%eax
c010b30b:	89 45 f4             	mov    %eax,-0xc(%ebp)
c010b30e:	8b 45 0c             	mov    0xc(%ebp),%eax
c010b311:	89 45 f0             	mov    %eax,-0x10(%ebp)
c010b314:	8b 45 10             	mov    0x10(%ebp),%eax
c010b317:	89 45 ec             	mov    %eax,-0x14(%ebp)
        "andl $3, %%ecx;"
        "jz 1f;"
        "rep; movsb;"
        "1:"
        : "=&c" (d0), "=&D" (d1), "=&S" (d2)
        : "0" (n / 4), "g" (n), "1" (dst), "2" (src)
c010b31a:	8b 45 ec             	mov    -0x14(%ebp),%eax
c010b31d:	c1 e8 02             	shr    $0x2,%eax
c010b320:	89 c1                	mov    %eax,%ecx
#ifndef __HAVE_ARCH_MEMCPY
#define __HAVE_ARCH_MEMCPY
static inline void *
__memcpy(void *dst, const void *src, size_t n) {
    int d0, d1, d2;
    asm volatile (
c010b322:	8b 55 f4             	mov    -0xc(%ebp),%edx
c010b325:	8b 45 f0             	mov    -0x10(%ebp),%eax
c010b328:	89 d7                	mov    %edx,%edi
c010b32a:	89 c6                	mov    %eax,%esi
c010b32c:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
c010b32e:	8b 4d ec             	mov    -0x14(%ebp),%ecx
c010b331:	83 e1 03             	and    $0x3,%ecx
c010b334:	74 02                	je     c010b338 <memcpy+0x38>
c010b336:	f3 a4                	rep movsb %ds:(%esi),%es:(%edi)
c010b338:	89 f0                	mov    %esi,%eax
c010b33a:	89 fa                	mov    %edi,%edx
c010b33c:	89 4d e8             	mov    %ecx,-0x18(%ebp)
c010b33f:	89 55 e4             	mov    %edx,-0x1c(%ebp)
c010b342:	89 45 e0             	mov    %eax,-0x20(%ebp)
        "rep; movsb;"
        "1:"
        : "=&c" (d0), "=&D" (d1), "=&S" (d2)
        : "0" (n / 4), "g" (n), "1" (dst), "2" (src)
        : "memory");
    return dst;
c010b345:	8b 45 f4             	mov    -0xc(%ebp),%eax
    while (n -- > 0) {
        *d ++ = *s ++;
    }
    return dst;
...
c010b348:	83 c4 20             	add    $0x20,%esp
c010b34b:	5e                   	pop    %esi
c010b34c:	5f                   	pop    %edi
c010b34d:	5d                   	pop    %ebp
c010b34e:	c3                   	ret    
...
c010b352:	83 ec 10             	sub    $0x10,%esp
    const char *s1 = (const char *)v1;
c010b355:	8b 45 08             	mov    0x8(%ebp),%eax
c010b358:	89 45 fc             	mov    %eax,-0x4(%ebp)
    const char *s2 = (const char *)v2;
c010b35b:	8b 45 0c             	mov    0xc(%ebp),%eax
c010b35e:	89 45 f8             	mov    %eax,-0x8(%ebp)
    while (n -- > 0) {
c010b361:	eb 30                	jmp    c010b393 <memcmp+0x44>
        if (*s1 != *s2) {
c010b363:	8b 45 fc             	mov    -0x4(%ebp),%eax
c010b366:	0f b6 10             	movzbl (%eax),%edx
c010b369:	8b 45 f8             	mov    -0x8(%ebp),%eax
c010b36c:	0f b6 00             	movzbl (%eax),%eax
c010b36f:	38 c2                	cmp    %al,%dl
c010b371:	74 18                	je     c010b38b <memcmp+0x3c>
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
c010b373:	8b 45 fc             	mov    -0x4(%ebp),%eax
c010b376:	0f b6 00             	movzbl (%eax),%eax
c010b379:	0f b6 d0             	movzbl %al,%edx
c010b37c:	8b 45 f8             	mov    -0x8(%ebp),%eax
c010b37f:	0f b6 00             	movzbl (%eax),%eax
c010b382:	0f b6 c0             	movzbl %al,%eax
c010b385:	29 c2                	sub    %eax,%edx
c010b387:	89 d0                	mov    %edx,%eax
c010b389:	eb 1a                	jmp    c010b3a5 <memcmp+0x56>
        }
        s1 ++, s2 ++;
c010b38b:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
c010b38f:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
 * */
int
memcmp(const void *v1, const void *v2, size_t n) {
    const char *s1 = (const char *)v1;
    const char *s2 = (const char *)v2;
    while (n -- > 0) {
c010b393:	8b 45 10             	mov    0x10(%ebp),%eax
c010b396:	8d 50 ff             	lea    -0x1(%eax),%edx
c010b399:	89 55 10             	mov    %edx,0x10(%ebp)
c010b39c:	85 c0                	test   %eax,%eax
c010b39e:	75 c3                	jne    c010b363 <memcmp+0x14>
        if (*s1 != *s2) {
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
        }
        s1 ++, s2 ++;
    ...
    return 0;
c010b3a0:	b8 00 00 00 00       	mov    $0x0,%eax
}
c010b3a5:	c9                   	leave  
c010b3a6:	c3                   	ret    
